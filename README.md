...
| `befund-*.md` | Datierte Befunde (Repo-Bestand, Typenlisten, Lesbarkeit, Typenvergleich abi/iqb); `befund-repo-stand-2026-09-17.md` ist der Stand des Repos als Einstieg für einen neuen Chat. |
