...
- `auftrag-nacht-2026-09-27.md` – Auftrag Nacht 2026-09-27 (zehn Teile: Belegskripte und Marken, FHR-Wort, Kleinposten, Vorrat-Verweise, Quellen, Vorschläge, Prüfskript, CAS-Nachtrag, 2017-be-gk); liegt in der Wurzel, solange er läuft, danach in `archiv/`.
- `nacht-stand-2026-09-27.md` – Standdatei dazu: je Teil offen/läuft/erledigt mit letztem Punkt und Commit; ein Neustart liest sie zuerst.
...
auf Ordner es überholt hat. `auftrag-testlauf-2026-09-25.md` ist der wiederkehrende Auftrag
Testlauf des Unterrichtsblatt-Prompts; für einen neuen Lauf (Posten in `faellig.md` § 2) in
die Wurzel kopieren und dort ausführen.
