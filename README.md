...
- `nacht-bericht-2026-09-29.md` – Bericht des Auftrags Nacht 2026-09-29 (Urteile vom 26.09. umgesetzt): acht Teile – Beschlüsse abgelegt, Deutungsliste (f) mit Abgleichlauf 26, Delta-Stapel 2018-ea-B CAS mit dokumentierter Unterschreitung, Berliner CAS-Hefte mit dem Reserve-Stapel 2017-ga-B CAS und Sek-II-Nachzug, marken-bau-Sollwert kreis 1, Merkkasten „0 = p(x)“, Vorschläge Sprossenregel und Katalogbefund 3–8; je Teil Gegenprobe, eigene Entscheidungen, offene Punkte.
