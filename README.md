...
- `auftrag-nacht-2026-09-28.md` – Auftrag Nacht 2026-09-28 (sieben Teile: Befund ablegen, Delta-Stapel CAS und Vormerkungen, Berliner CAS-Hefte messen, Sek-II-Einträge nachziehen, Prüfskript, Eichung 2017, Prüfstein Übersichtsblatt); liegt in der Wurzel, solange er läuft, danach in `archiv/`.
- `nacht-stand-2026-09-28.md` – Standdatei dazu: je Teil offen/läuft/erledigt mit letztem Punkt und Commit; ein Neustart liest sie zuerst.
