...
Amtliche Vorgaben: die Prüfungsschwerpunkte des jeweiligen Schuljahres und das Rundschreiben des MBJS zu Terminen und Fristen. Sie stehen mit Quellen, Historie und Jahrescheck in fhr-vorgaben.md (seit 17.09.2026; Entscheidung 19) und werden dort jährlich geprüft; für die Erfassung reicht dieses Profil.
...
- Stufenzahl im Typnamen (Abgleichlauf 12.09.2026): unter Mehrstufige Zufallsexperimente heißen die Typen „mehrstufig mit" bzw. „mehrstufig ohne Zurücklegen" – die Stufenzahl trennt dort nicht, sie steht in gegeben und schritte; unter Baumdiagramm und Pfadregeln bleibt „zweistufig" im Namen, weil es dort nach der Arbeitsregel oben die Themenbedingung ist. Die Uneinheitlichkeit ist der Preis dafür, dass Typen nicht über Themengrenzen hinweg zusammengezogen werden (§ 7).
...
- Typen werden nicht über Themengrenzen hinweg zusammengezogen (Abgleichlauf 12.09.2026): Dreiecksfläche aus Punktkoordinaten berechnen und Dreiecksfläche aus Achsenabschnitten einer Geraden bleiben getrennt, ebenso Extrempunkt und Wendepunkt über notwendige Bedingung ausschließen. Schnittpunkt mit der y-Achse bleibt unter Nullstellen ganzrationaler Funktionen, obwohl der y-Achsenschnitt keine Nullstelle ist – ein eigenes Thema für einen Typ lohnt nicht. Der typ Vierfeldertafel vervollständigen bleibt unter Unabhängigkeit von Ereignissen (zwei der drei Vorkommen), die Zeile 2023-A-3a behält davon abweichend thema Daten darstellen und aufbereiten (Regel oben).
- **Decke einer Kette, Vorgabenstand der Originale** (Regel seit 12.09.2026; die frühere Regel „Decke ist immer ein Original ab 2023" ist aufgehoben): Für die Decke gilt blatt-konzept.md § 3 ohne Einschränkung – alle Originale eines Typs sind Sprossen, geordnet nach Merkmalen und nicht nach Jahr; Decke ist das Original mit den meisten Merkmalen, das Jahr entscheidet nur bei Gleichstand. Grund: 29 der 135 Typen haben kein Vorkommen ab 2023, darunter beide Fundstellen des Themas Erwartungswert (2019-C-3d, 2021-B-3e), und der Zuwachs neuer Typen je Jahrgang rückwärts von 2026 bis 2019 war 25, 18, 11, 9, 7, 11, 3 und 2 – die ältesten Jahrgänge bringen kaum Neues, aber ohne sie hätten 29 Typen keine Decke; wovor der Vorgabenstand schützen soll, filtert die Themenliste über die Schwerpunktmarkierung (§ 6). Der Vorgabenstand bleibt Information für das Protokoll zur gewählten Decke, damit der Lehrer im Einzelfall widersprechen kann: 2019 vor dem Rahmenlehrplan vom 01.08.2019, 2020 unter dem heutigen Rahmenlehrplan vor den Kürzungen, 2021 und 2022 unter coronabedingt gekürzten Vorgaben. Kein eigenes Feld – das Jahr steht in id und jahr.
