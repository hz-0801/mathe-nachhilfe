...
# Der Block ist leer; zuletzt erfasst: 2022-ga-B (WTR-Zweig, 17.09.2026, 52 Zeilen,
# 28 neue Typen, KONFIG oben; Lauf aus dem HEAD-Stand byteidentisch). Die neun
# Schätzungen dieses Stapels, die aus den Landeszeilen 2022-bebb-gk übernommen
# waren und neben der Spalte Anforderungsbereich lagen, hat abgleich.py Lauf 20
# auf den amtlichen Bereich gesetzt (Vorrang des Amtlichen, Kern § 5); die
# Überschreibung der Eichschwelle je Stapel (v1.4) ist mit v1.5 zurückgebaut.
