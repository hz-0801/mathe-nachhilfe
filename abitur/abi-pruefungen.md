...
Stand 29.09.2026 · Profil abi · gepflegt vom Katalog-Prompt
...
| 2017 | 2017-bb-ea | BB | erhöht | WTR | 10 | 270 | 100 | **erfasst 2026-09-12, 36 Zeilen** (alle Aufgaben, beide Wahlwege) · Leitfassung erhöht · Pool: Teil 1 = 2017 erhöht Teil A (6 „Dublette von:“ seit Lauf 15); 3.1 Zelt = 2017 erhöht Teil B AG/LA (A2) CAS 2 – seit Lauf 25 4 „Dublette von:“ (3.1 a, b, c, d; c mit 5 statt 4 BE) und 2 „Abgewandelt von:“ (3.1 e, f; § 4) |
| 2017 | 2017-be-gk-cas | BE | grundlegend | CAS | 8 | 210 | 80 | **erfasst 2026-09-29, 16 Zeilen** (CAS-Nachtrag nach dem Beschluss vom 26.09.2026 Punkt 3, abi-bau.py v0.15: 11 eigene Zeilen für die Arten Werkzeug, Auftrag, Zuschnitt, ganze Aufgabe – 1.1 a, e, f; 1.2 a, b, d, f; 2.2 c; 3.1 e, g; 3.2 d – und 5 Landes-Dubletten „Dublette von: <WTR-id>“ mit BE-Vermerk – 1.1 b, c; 1.2 e; 2.2 d; 3.2 c) mit 86 BE, dazu 54 BE wortgleich übernommen und 20 BE unverändert (2.1) – 160 angeboten wie im WTR-Heft · Pool: 3.1 Smartphone ist die CAS-Poolfassung 2017 grundlegend Teil B Stochastik (Stapel 2017-ga-B-cas, erfasst) – 3.1 e, g „Dublette von:“ auf 2017MgrundlegendBStochastikCAS-2c, -2e, keine Vormerkung · WTR 1.1 f ohne CAS-Gegenstück (§ 4) |
| 2017 | 2017-be-lk-cas | BE | erhöht | CAS | 9 | 270 | 100 | **Nachtrag geprüft 2026-09-29, 0 Zeilen** (Beschluss vom 26.09.2026 Punkt 3): 19 abweichende Teilaufgaben – 9 in 1.2 Straßenverlauf, 2.2 Zelt, 3.2 Freizeit sind schon Zeilen von 2017-bb-ea-cas (Verweis wie bei einem Zwilling, § 4); 10 in den eigenen Berliner Aufgaben 1.1, 2.1, 3.1, deren WTR-Fassung keine Zeile hat, nicht erfasst (offener Posten in faellig.md) |
| 2017 | 2017-bb-ea-cas | BB | erhöht | CAS | 10 | 270 | 100 | **erfasst 2026-09-27, 14 Zeilen** (CAS-Nachtrag: nur abweichende Teilaufgaben; 4 „CAS:“-Aufgaben – 2.1 Eisbecher, 2.2 Straßenverlauf, 3.1 Zelt, 4.2 Freizeit) · Zeilen 2.1 a, b, c, e, f; 2.2 b, d, g; 3.1 c, e, f; 4.2 a, b, d mit 87 BE, dazu 63 BE wortgleich übernommen und 35 BE unverändert (Teil 1, 3.2, 4.1) – 185 angeboten wie im WTR-Heft · 3.1 Zelt ist die Poolaufgabe 2017MerhoehtBAGLAA2CAS2: im Heftlauf 3 Vormerkungen (Stapel 2017-ea-B, CAS-Zweig, damals nicht erfasst); Stapel erfasst 2026-09-28, seit Lauf 25 1 „Dublette von:“ (3.1 c) und 2 „Abgewandelt von:“ (3.1 e, f: Ebene F zusätzlich im Aufgabenstamm; § 4) |
...
| 2017-bb-ea | 36 | – | – | – | – | – | – | – | – | 6 von 36; 15 von 185 (8 %), seit Lauf 15 alle „Dublette von:“ (2017-ea-A erfasst); seit Lauf 25 10 von 36; 32 von 185 BE (17 %) – dazu 3.1 a, b, c, d auf AG/LA (A2) CAS 2 (2017-ea-B-cas erfasst; c mit 5 statt 4 BE); abgewandelt 2 Zeilen, 8 BE (3.1 e, f) |
...
| 2026-bb-ea | 50 | 51 | 6 (12 %) | 36 von 39 (92 %), alle 39 geerbt; eigene 0 | 0 | 0 | 10 von 51 (20 %) | Heft (bb-ea) 0; alle: be-gk 7, be-lk 0, bb-gk 7, bb-ea 0 | 36 Werte, 50 von 50 Zeilen im Niveau bekannt (100 %), 0 Werte neu im Gesamtbestand | 39 von 50; 115 von 150 (77 %) |
...
Lücken sind Tipp- und Lösungsseiten, das Heft ist vollständig.
Scanqualität: Seite 1 kontrastarm mit Durchscheinen, lesbar; Seiten 4 und 5
am rechten Rand beschnitten, die BE-Spalte dort nur teilweise sichtbar –
Aufgabe 2.1 Aufgabenteil 2 (3, 3, 2, 5) über die wortgleiche Poolaufgabe
Analysis WTR 2 und das Heftsoll 45 gesichert, Aufgabe 2.2 a–f (2, 6, 5, 4, 4,
4) aus einem Randausschnitt gelesen und über das Soll 45 bestätigt; Seite 5
ist als Doppelseite mit der rechten Nachbarseite fotografiert. 57 Zeilen aus
11 Aufgaben (1.1 bis 1.7 der hilfsmittelfreie Teil in Heftreihenfolge –
Analysis 1 bis 3, Analytische Geometrie 1 und 2, Stochastik 1 und 2 –, 2.1
mit zwei Aufgabenteilen als a–m durchgezählt, 2.2, 3, 4); alle elf
Punktsummen stimmen (7 × 5, 45, 45, 30, 30 = 185 BE angeboten).
Selbstprüfung beider Bau-Skripte bestanden (abi 275 Zeilen aus 6 Heften, iqb
1206 Zeilen, 1039 Typen, 117 in beiden Katalogen), Lauf aus dem HEAD-Stand
byteidentisch.

*Pool-Abgleich.* Zwei Quellen: der erfasste Pool 2022 grundlegend Teil A
(iqb-katalog.csv) und die sieben Dateien des Pools 2022 grundlegend Teil B
(WTR), die als Reserve nicht erfasst sind – dafür geholt, Text mit pypdf,
am Wortlaut verglichen. **24 von 57 Zeilen sind Poolaufgaben, 72 von 185
angebotenen BE (39 %)**: im hilfsmittelfreien Teil vier der sieben Einheiten
(1.3 = Analysis 2, 1.4 = AG/LA (A2) 1.1 a–c, 1.5 = AG/LA (A2) 1.2 a, b, 1.7 =
Stochastik 1.2 a, b – 20 von 35 BE, acht Zeilen „Dublette von:"), in Teil B
die Aufgabe 2.1 zu 25 von 45 BE (Aufgabenteil 1 a, b, g und der ganze
Aufgabenteil 2 aus Analysis WTR 2; c ist eine Landesfassung, d, e, f, h, i
Landeszusätze), die Aufgabe 3 zu 20 von 30 BE (b, d, e, f, g, i aus AG/LA
(A2) WTR 2; a, c, h Landeszusätze) und die Aufgabe 4 zu 18 von 30 BE (b, c,
e, h, i, j aus Stochastik WTR 1; a, d, f, g Landeszusätze); 2.2
(Hochwasserschutz) ist ganz Landesaufgabe. Die 19 Teil-B-Zeilen tragen die
Vorstufe „Poolaufgabe (nicht erfasst): 2022MgrundlegendB…" (offener Posten,
bis 2022-ga-B erfasst ist), drei davon als abgewandelt: 2.1 m (Zeitraum mit
„mindestens" statt „größer als" 29,7), 3 g und 4 j (das Heft lässt die
Rechnung zu, der Pool verlangt die Begründung ohne Rechnung). Muster: Berlin/
Brandenburg 2022 nimmt Poolaufgaben und ergänzt sie um eigene Teilaufgaben –
anders als 2023 und 2024, wo die Poolaufgaben ganz übernommen wurden.
Kontextgebundene Zeilen: keine (Tauchroboter, Betonteil, Kirchturm, Pakete
sind Sachkontexte ohne Trägerbindung).

*Typen.* 60 verwendet, 33 neu (55 %), 22 aus dem iqb-Katalog (8 über die
Dubletten, 14 wiederverwendet: Tangentengleichung, Graphen von f und f'
zuordnen, Schnittwinkel zweier Graphen, Wendepunkt als Zeitpunkt stärkster
Änderung, Länge des Zeitraums mit Mindeständerungsrate, Lage und Art der
Extrempunkte, Stelle mit lokaler gleich mittlerer Änderungsrate,
Stammfunktion durch Ableiten, Parametergleichung einer Ebene,
Normalenvektor über Skalarprodukte, parallele Ebene, Symmetrieebene
auswählen, Bernoulli-Bedingungen, Vierfeldertafel), 5 aus dem abi-Bestand
(Punktprobe an der Ebene, Ziehen ohne Zurücklegen über das Gegenereignis,
Mindestanzahl einer Bernoulli-Kette, Trefferwahrscheinlichkeit aus null
Treffern, Einzel- und kumulierte Binomialwahrscheinlichkeit – im Heft mit
Tabelle statt Rechner, Etikett beibehalten). Die neuen Typen nach Thema:
Kurvenuntersuchung 5, Tangente/Normale 4, Fläche 5 (darunter Existenz eines
Flächenstücks mit vorgegebenem Inhalt, Änderung beim Ersetzen durch die
Sehne), Grenzwerte 2, Rekonstruktion 2, Extremalprobleme 1, Gleichungen
lösen 1, Funktionsklassen 2, Punkte und Strecken 1, Flächeninhalt und
Volumen 3 (Quadratverhältnis, Rauteninnenwinkel und Dachfläche, Volumenterm
des Dachs), Abstände 2 (Strahlensatz, Lotfußpunkt beschreiben), Kenngrößen 1,
Baumdiagramm 2, Zufallsexperimente 2, Unabhängigkeit 1. Etikettenfragen:
Aufgabe 1.6 a (mindestens eine grüne Kugel ohne Zurücklegen) läuft unter dem
abi-Typ der hypergeometrischen Verteilung (2018-bb-ea) – für be-gk außerhalb,
für bb-gk innerhalb der Geltung, nach der neuen Regel in Geltung; 4 i
(Anteile unter schweren und nicht schweren Paketen vergleichen) bekommt einen
eigenen Typ neben der Produktregel (anderer Lösungsweg, Kern § 6).

*Eichung.* 7 von 8 gewerteten Zeilen (88 %, unter zehn Zeilen nicht scharf)
– nur die acht Teil-A-Dubletten tragen einen amtlichen Bereich; die
Abweichung 1.7 a (bedingte Wahrscheinlichkeit als Quotient, I gegen II) ist
dieselbe wie in der Poolzeile. 49 Landeszeilen nach der engen Fassung
geschätzt: 11 mit III, 27 mit II, 11 mit I.

*Schnitt.* 36 Werte auf 57 Zeilen; alle 57 Zeilen liegen auf bekannten Werten
des grundlegenden Niveaus, **kein neuer Wert im Gesamtbestand** (186 Werte,
be-gk 152, bb-ea 173); 34 der 49 Landeszeilen liegen auf Werten aus Teil A
des grundlegenden Pools. Geltung: alle 57 Zeilen in der Geltung des Hefts
(be-gk oder bb-gk); nur gegen be-gk läge 1.6 a außerhalb (hypergeometrische
Verteilung).

*Aufwand.* Rendern und Lesen der zwölf Seiten, Holen und Lesen von sieben
Pooldateien, Randausschnitte für die beschnittenen BE-Spalten, Rechnung mit
...
Aufgabenteil 2 a–d) unscharf und am rechten Rand beschnitten – Text mit
Vergrößerung gelesen, BE der Poolteile aus den Poolzeilen, die vier BE der
Landesteile c und d über das Heftsoll 40 gesichert; Handschatten auf den
Seiten 2, 6, 8, 10, 11 und 14, sonst alles lesbar. 66 Zeilen aus 12 Aufgaben
(1.1 bis 1.8 der hilfsmittelfreie Teil in Heftreihenfolge, je 5 BE; 2.1; 2.2
mit zwei Aufgabenteilen als a–n; 3; 4 mit zwei Aufgabenteilen als a–l); alle
zwölf Punktsummen stimmen (8 × 5, 50, 50, 40, 40 = 220 BE angeboten, 170
bei Wahl). Selbstprüfung beider Bau-Skripte bestanden (abi 448 Zeilen aus 9
Heften, iqb 1206 Zeilen, 1090 Typen, 198 in beiden Katalogen), Lauf aus dem
HEAD-Stand byteidentisch.

*Pool-Abgleich (gegen den erhöhten Pool 2023, Teil A und B erfasst).* **33
von 66 Zeilen sind wortgleiche Poolaufgaben, 105 von 220 angebotenen BE
(48 %)**, dazu zwei abgewandelte (3 e, 3 g; 9 BE). Sitz im Heft: im
hilfsmittelfreien Teil sechs der acht Einheiten (1.1 = Analysis 1.1, 1.3 =
Analysis 1.2, 1.5 = AG/LA (A2) 1.3, 1.6 = AG/LA (A2) 2.2, 1.7 = Stochastik
1.1, 1.8 = Stochastik 2.2 – 30 von 40 BE; Landes nur 1.2 (ln-Funktion) und
1.4 (f' vorgegeben)); 2.2 (Stau) ist Analysis WTR 1 – Aufgabenteil 1
vollständig, Aufgabenteil 2 a, c, d –, die Poolteilaufgabe 2 b (gemeinsame
Punkte der Schar) ist durch vier Landeszusätze i–l ersetzt (waagerechte
Tangente in A, Tiefpunkt oder Sattelpunkt nach der Parität, Fläche zwischen
h₁ und h₂, Parameter aus einer Wertdifferenz; 37 von 50 BE aus dem Pool); 3
(Körper) ist AG/LA (A2) WTR 2 in a–d und f (18 BE), e und g sind
abgewandelt (e: das Heft nennt die vier Kanten und lässt die Punkte auf g
suchen, der Pool fragt nach dem Parameterbereich; g: das Heft verlangt die
Beschreibung des Lösungswegs für 5 BE, der Pool gibt den Rechenweg vor und
fragt nach Aufgabenstellung und Bedeutung von S für 3 BE), h–k sind
Landeszusätze mit der Ebenenschar H_d (Kante in der Ebene, Schnittdreieck,
Abstand 1, kleinstes d₀); 4 (Urlaubsreise) ist Stochastik WTR 2 in
Aufgabenteil 1 c–f und Aufgabenteil 2 a–b (20 BE), a und b (Binomialtest auf
Anteile, Termdeutung) sowie Aufgabenteil 2 c–f (Entscheidungsregel, Fehler
zweiter Art, zweimal hypergeometrisch) sind Landeszusätze – die
Poolteilaufgabe 2 c (Nutzen eines größeren Umfangs an den Gütekurven) fehlt
im Heft. 2.1 (Trainingsstrecke, Schar (4a − x) · e^(x/2) mit Skipiste, 50
BE, 13 Zeilen) ist ganz Landesaufgabe. Nach zu bearbeitenden BE: 55 oder 105
von 170 (32 % oder 62 %), je nach Wahl 2.1 oder 2.2. Muster wie 2022-bebb-lk:
Poolaufgaben mit ersetzten oder ergänzten Teilaufgaben, der Landesanteil sitzt
in der Funktionenschar 2.1 und in den Zusätzen. Das Heft schreibt in Aufgabe
3 wie der Pool x₁, x₂, x₃, im hilfsmittelfreien Teil x, y, z. Die 33
Dubletten-Zeilen sind aus den Poolzeilen erzeugt (dubletten.py);
Wortgleichheit je Teilaufgabe am Heft geprüft. Kontextgebundene Zeilen:
keine.

*Typen.* 68 verwendet, 24 neu (35 %), 40 im iqb-Katalog vorhanden (33 über
die Dubletten, dazu wiederverwendet: Grenzverhalten eines Produkts aus
Polynom und e-Funktion, Stammfunktion durch Ableiten, Fläche zwischen zwei
Graphen, kumulierte Binomialwahrscheinlichkeit mit dem Rechner,
Entscheidungsregel eines einseitigen Tests, hypergeometrische
Wahrscheinlichkeit über Binomialkoeffizienten, als Nebentyp Flächeninhalt
mit Maßstab), 4 aus dem abi-Bestand (Definitionsbereich einer
Logarithmusfunktion 2017-bb-ea, vertikaler Abstand als Differenz von
Funktionswerten 2018-be-gk, Grenzverhalten 2023-bebb-gk, Ortskurve durch
Elimination 2022-bebb-lk). Die neuen Typen nach Thema: Funktionsscharen und
Ortskurven 9 (Achsendreieck der Schar, Ableitung mit zusammenhängendem
Monotoniebereich, einziger Extrempunkt, konstanter Abstand von Extrem- und
Wendestelle, Schnittwinkel mit der Ortskurve, kleinster Abstand zum Ursprung
an der Ortskurve, waagerechte Tangente aller Scharkurven, Tiefpunkt oder
Sattelpunkt nach der Parität, Parameter aus einer Wertdifferenz), Scharen
von Geraden und Ebenen 5 (Punkte auf g für eine Ebene durch die Achse, Kante
in der Scharebene, weiterer Eckpunkt des Schnittdreiecks, Abstand zur
Scharebene, kleinstes d₀), Rekonstruktion 3 (Integrationskonstante aus einer
Tangente, Unmöglichkeit einer einzigen Parabel, Parabel ohne lineares Glied
aus einem Flächeninhalt), Kurvenuntersuchung 1, Tangente 1, Gleichungen lösen
1 (achsenparallele Quadrate), Punkte und Strecken 1 (Lösungsweg einer Drehung
beschreiben), Ereignisse und Mengenoperationen 1, Hypothesentests 1 (Fehler
zweiter Art für zwei Anteile mit Deutung), Hypergeometrische Verteilung 1.
Etikettenfragen: 4 j bekommt einen eigenen Typ neben „Fehler zweiter Art für
einen selbst gewählten Anteil berechnen und mit einer Schranke vergleichen"
(2024-ea-B; hier zwei Werte und Deutung) – Kandidat für den Abgleichlauf; 4 k
läuft unter dem Pooltyp der hypergeometrischen Wahrscheinlichkeit (2024-ea-B,
dort Nachweis eines Werts); 2.1 f nutzt den Ortskurventyp aus 2022-bebb-lk,
obwohl die Gleichung vorgegeben ist (gleicher Weg).

*Eichung.* 27 von 33 gewerteten Zeilen (82 %) – alle 33 sind Dubletten mit
geerbter Schätzung; die sechs Abweichungen (2.2 a, c, g, 3 c, d, 4 e) sind
die der Poolzeilen 2023-ea-B (dort 55 von 64, das Heft erbt sechs der neun
Abweichungen; 2023-ea-A ohne Abweichung im Heft). Die Schwelle zählt seit
v0.8 nur eigene Schätzungen (keine), Kennzahl wie ausgewiesen. Die 33
Landeszeilen (samt zwei abgewandelten) ohne amtlichen Bereich nach der engen
Fassung: 6 mit III (Schnittwinkel über den Sonderfall 2.1 g, kleinster
Abstand an der Ortskurve 2.1 h, Parabel aus dem Flächeninhalt 2.1 m, Punkte
auf g 3 e, Lösungsweg der Drehung 3 g, kleinstes d₀ 3 k), 17 mit II, 10 mit
I.

*Schnitt.* 42 Werte auf 66 Zeilen; 62 von 66 Zeilen liegen auf bekannten
Werten des erhöhten Niveaus, neu im Niveau drei Werte (Ereignisse ·
angeben, Gleichungen lösen · zeichnen, Rekonstruktion · begründen), **zwei
davon neu im Gesamtbestand** (Gleichungen lösen · zeichnen aus 2.1 i,
Rekonstruktion von Funktionsgleichungen · begründen aus 2.1 l; Gesamtbestand
jetzt 188 Werte, be-gk 154, bb-ea 175). 21 der 33 Landeszeilen liegen auf
Werten aus Teil A des erhöhten Pools. Geltung: alle 66 Zeilen in der
Geltung des Hefts (be-lk oder bb-ea); nur gegen be-lk lägen 4 k und 4 l
außerhalb (Hypergeometrische Verteilung, gilt nur in Brandenburg – erster
Fall, in dem die Regel „mindestens eine Spalte" bei einem erhöhten Heft
trägt). **25 Zeilen lägen außerhalb der Geltung der Grundkurse** (be-gk 25,
bb-gk 23): Funktionsscharen und Ortskurven 15 (1.3 a–b, 2.1 a, c–h, 2.2 h,
i, j, l, m, n), Scharen von Geraden und Ebenen 6 (1.5 b, 3 e, h–k),
Hypothesentests 2 (4 i, j), Hypergeometrische Verteilung 2 (4 k, l; für bb-gk
in Geltung). Neun Schnittwerte des Hefts fehlen im grundlegenden Bestand.

*Aufwand.* Rendern und Lesen der 14 Seiten (Seite 13 mit Vergrößerung),
Pool-Abgleich gegen 101 Poolzeilen, Rechnung der 31 Landeszeilen und zwei
...
klären, Reste schließen, vier Stark-Hefte erfassen", Punkt 5; abitur-abgleich.py
...
**Abgleichlauf 18 – Verweise von 2022-bebb-gk geschlossen (17.09.2026,
Auftrag „2026 Brandenburg erfassen, Reserve 2022-ga-B öffnen", Punkt 2;
abitur-abgleich.py v0.18).** Nach der Erfassung des Reserve-Stapels 2022-ga-B
(iqb-pruefungen.md § 4) wurden alle 19 Vormerkungen des Hefts umgestellt: 16
wortgleiche auf „Dublette von: <id>." (2.1 a, b, g, j, k, l; 3 b, d, e, f,
i; 4 b, c, e, h, i) mit der AB-Spalte der Poolzeile in afb_amtlich und
bemerkung, 3 abgewandelte auf „Abgewandelt von: <id>; <Unterschied>." (2.1 m
„mindestens" statt „größer als", 3 g und 4 j Rechnung zugelassen statt
Begründung ohne Rechnung). Typvergleich je Paar bestanden (die Poolzeilen
wurden aus den Landeszeilen erzeugt, Typ und Schätzung identisch); kein
Vermerk bleibt offen, Typen unverändert (1115). Folge für die Eichung des
Hefts: 16 von 24 gewerteten Zeilen (67 %) – die acht Abweichungen sind 1.7 a
(Teil A, wie im Heftlauf) und 2.1 a, g, j, k, 3 b, e, i; sie sind keine
geerbten Schätzungen (die Landeszeilen haben zuerst geschätzt), also eigene
und zählen in der Bestandseichung (jetzt 143 von 165, 86 %). Befund: die
Landeszeilen von 2022-bebb-gk liegen tendenziell einen Bereich über dem
Standardbezug – 6 der 7 Teil-B-Abweichungen nach oben (2.1 a, j, 3 b, e:
...
„amtlich", afb_amtlich der Landeszeilen leer). 50 Zeilen aus 14 Aufgaben
(hilfsmittelfreier Teil 1.1 bis 1.10 in Heftreihenfolge – 1.1–1.4 Pflicht,
1.5–1.10 Wahlaufgaben, je 5 BE –, 2.1 a–i, 2.2 a–h, 3, 4 a–h mit drei
Aufgabenteilen); alle vierzehn Punktsummen stimmen (10 × 5, 30, 30, 20, 20
= 150 BE angeboten, 100 bei Wahl). Selbstprüfung beider Bau-Skripte
bestanden (abi 543 Zeilen aus 11 Heften, iqb 1258, 1127 Typen, 260 in
beiden Katalogen), Lauf aus dem HEAD-Stand byteidentisch.

*Pool-Abgleich (gegen den erfassten Pool 2026 erhöht, Teil A und B).* **39
von 50 Zeilen sind wortgleiche Poolaufgaben, 115 von 150 angebotenen BE
(77 %)**: im hilfsmittelfreien Teil neun der zehn Einheiten (1.1 =
Analysis 1.4, 1.2 = Analysis 1.1, 1.3 = AG/LA (A2) 1.1, 1.4 = Stochastik
1.1, 1.5 = Analysis 2.1, 1.7 = AG/LA (A2) 2.2, 1.8 = AG/LA (A2) 2.1, 1.9 =
Stochastik 2.3, 1.10 = Stochastik 2.1 – 45 von 50 BE), 2.2 = Analysis WTR 1
vollständig (30 BE), 3 = AG/LA (A2) WTR 2 vollständig (20 BE), 4 =
Stochastik WTR 1 vollständig (20 BE). Landesaufgaben: 1.6 (Schar 1/2 x³ −
2a²x mit Integral ohne Rechnung, 5 BE) und 2.1 (Weltbevölkerung, 30 BE,
neun Zeilen). Nach zu bearbeitenden BE: 65 oder 95 von 100 (65 % oder
95 %), je nach Wahl 2.1 oder 2.2 und Teil-A-Wahl ohne 1.6. Wie im
Grundkurs: **die getrennte Prüfung 2026 schöpft weiter aus dem Pool** –
erhöht sogar stärker als jedes bisher erfasste LK-Heft (2022 45 %, 2023
48 %). Die 39 Dubletten-Zeilen sind aus den Poolzeilen erzeugt
(dubletten.py); Wortgleichheit je Teilaufgabe am Heft geprüft, alle
Treffer ohne Abweichung. Kontextgebundene Zeilen: keine.

*Verhältnis zum Grundkursheft 2026-bb-gk.* Aufgabe 4 (Treuepunkte) und
Aufgabe 3 (Pyramide) stehen in beiden Heften. Beide Male ist es der Pool,
je aus der Datei des eigenen Niveaus: Stochastik WTR 1 erhöht ist die
erweiterte Fassung der grundlegenden Aufgabe (Aufgabenteil 1 a, b = GK 1 b,
c; 2 b, c wortgleich, 2 a verschieden – Anzahl kleiner als 400 000 statt
Verhältnis sechsmal; Aufgabenteil 3 zur Normalverteilung nur erhöht), AG/LA
(A2) WTR 2 erhöht ist strukturgleich mit anderen Koordinaten (A(0|−3|0)
statt (0|−2|0), zusätzlich Drehkreis der Spitze). Die Verweise gehen auf die
Poolzeilen des eigenen Niveaus, die Heftgleichheit ist Poolgleichheit
(Vermerke in bemerkung); die Dublettenregel zwischen zwei abi-Heften wurde
nicht gebraucht. Wo sie klemmen würde: der Verweis „Dublette von:" verlangt
eine Pool-Kennung (KENNUNG in abi-bau.py), die Zielzeile wird nur in
ANDERE_KATALOGE (iqb) gesucht, die Poolquote zählt jeden Verweis als Pool,
und die Eichung erbt nur von Poolzeilen – ein Verweis zwischen zwei
abi-Zeilen bräuchte eine eigene Markierung mit eigener Zählung (abi.md § 9).

*Typen.* 51 verwendet, 6 neu (12 %), 43 aus dem iqb-Katalog (39 über die
Dubletten, dazu Punkt durch Einsetzen, Integral über ungerade Funktion plus
Konstante, Parameterwerte nach der Anzahl der Extrempunkte, Mittelwert einer
Funktion), 2 aus dem abi-Bestand (Extremstelle aller Stammfunktionen aus
2026-bb-gk, Mittelwert 2023-bebb-gk). Die neuen Typen: Punktsymmetrie und
gemeinsame Tangente aller Scharkurven (Funktionsscharen), größter
Funktionswert über Monotonie, Grenzwert und Symmetrie (Kurvenuntersuchung),
Ursprungsgerade als Winkelhalbierende (Tangente), Faktor eines
Stammfunktionsterms r/x · f (Stammfunktion), Parameter einer
Exponentialfunktion aus der Anfangsänderungsrate und Maximum eines
Parabelmodells aus Symmetrie und Differenzbedingung (Rekonstruktion).
Etikettenfragen: 2.1 b läuft unter „Parameterwerte nach der Anzahl der
Extrempunkte …" (2022-ea-B) – dieselbe Fallunterscheidung, hier Anzahl je
Parameter; 1.6 b unter dem grundlegenden Pooltyp von 2026-ga-B (Integral
über ungerade Funktion plus Konstante), hier mit Parameter.

*Eichung.* 36 von 39 gewerteten Zeilen (92 %), alle geerbt; die drei
Abweichungen (1.2 a, b und 1.4 b – Analysis 1.1 a, b und Stochastik 1.1 b)
sind die der Poolzeilen 2026-ea-A. Die elf Landeszeilen nach der engen
Fassung: 2 mit III (Winkelhalbierende 2.1 d, Parabelmaximum 2.1 i), 7 mit
II, 2 mit I.

*Schnitt.* 36 Werte auf 50 Zeilen; alle 50 Zeilen auf bekannten Werten des
erhöhten Niveaus, **kein neuer Wert im Gesamtbestand** (188 Werte, be-gk
154, bb-ea 175); 10 der 11 Landeszeilen auf Werten aus Teil A des erhöhten
Pools. Geltung: alle 50 Zeilen in bb-ea; außerhalb der Grundkursgeltung 7
(Funktionsscharen 2.1 a, b, 2.2 a, b; Normalverteilung 4 f–h).

*Aufwand.* Textextraktion, Rendern und Lesen von elf Aufgabenseiten,
Pool-Abgleich, Rechnung der Landesaufgaben mit sympy, Erzeugen der 39
Dubletten, elf Zeilen von Hand, Lauf, HEAD-Rerun und Selbstprüfung: etwa 35
Minuten (die Scan-Hefte gleicher Größe 2022/2023-bebb-lk: 70–80 Minuten bei
...
öffnen", Punkt 6; abitur-abgleich.py v0.19).** Die 40 neuen Typen des Auftrags
...
ordnen", Teil 1; abitur-abgleich.py v0.20, Kern v0.6, abi.md v0.15, iqb-bau.py
...
**2020-be-gk erfasst (17.09.2026, Auftrag B, Teil 1; abi-bau.py v0.8, abi.md
v0.18).** Stark-Band zum Abitur 2021 (Berlin), PDF mit Textebene, 49 Seiten
A5; Aufgabenseiten 1, 8–9, 16–17, 25, 31, 37, 43–44 aus dem Text ermittelt,
Abbildungen (Anlagen zu 2.1 und 2.2, Theaterhalle 3.2, Würfelnetze 4.1,
Baumdiagramm und Term 4.2) gerendert gelesen; Tipps und Verlagslösungen nicht
erfasst. **Heftaufbau 2020 (aus dem Heft):** Aufgabe 1 hilfsmittelfreier Teil
mit fünf Pflichteinheiten (Analysis 1, Analysis 2, Geometrie 1, Geometrie 2,
Stochastik) zu je 5 BE (25 BE, gegenüber 2019 eine Einheit mehr); Teil B mit
Wahl in allen drei Sachgebieten – 2.1/2.2 Analysis je 35 BE (2019: 40),
3.1/3.2 und 4.1/4.2 je 20 BE; bearbeitet 100 BE, angeboten 175. 51 Zeilen aus
11 Aufgaben, alle elf Punktsummen stimmen (5 × 5, 35, 35, 20, 20, 20, 20).
Selbstprüfung beider Bau-Skripte bestanden (abi 639 Zeilen aus 13 Heften, iqb
1258, 1166 Typen), Lauf aus dem HEAD-Stand byteidentisch.

*Pool-Abgleich (Textvergleich gegen die 16 WTR-Dateien des Pools 2020
grundlegend).* Teil A: Analysis 2 = Pool Analysis 1.2 (wortgleich, eine
Einheit ohne Teilaufgaben), Stochastik = Pool Stochastik 1.1 (a mit
eingefügtem „nacheinander", b wortgleich – beide als Dubletten geführt);
Analysis 1, Geometrie 1 und 2 Landes. Teil B: 4.2 Unternehmen = Pool
Stochastik WTR 1 – Aufgabenteil 2 (a–c) wortgleich, Aufgabenteil 1 (a–d) mit
anderen Zahlen (1/3 statt 29 %, 50 statt 40, 17 statt 12, viermal statt
dreimal, 16/17 statt 11/12) abgewandelt; 2.1 Exponentialfunktion, 2.2
Teststrecke, 3.1 Ebenen, 3.2 Theater, 4.1 Würfel Landes. Der Stapel
2020-ga-B ist Reserve: sieben Vormerkungen (drei wortgleich, vier
abgewandelt; offene Posten). **Poolquote 6 von 51 Zeilen, 20 von 175 BE
(11 %)**, dazu 4 abgewandelte Zeilen (10 BE); Sitz: Teil A 10 von 25 BE, Teil
B nur 4.2 Aufgabenteil 2 (10 BE). Kontextgebundene Zeilen: keine.

*Typen.* 54 verwendet, 17 neu (31 %), 25 aus dem iqb-Katalog (3 Dubletten,
dazu u. a. Ableitung eines Produkts mit e-Funktion nachweisen, Hochpunkt
Polynom · e-Funktion, Tangentengleichung und Schnittwinkel, Stammfunktion
nachweisen und mit Wertebedingung, Koordinatengleichung einer Ebene,
Lotfußpunkt, Baumdiagramm mit Abbruchbedingung, Augensumme bei zwei Würfen,
Bayes aus dem Baumdiagramm, Maximum der Binomialverteilung), 12 aus dem
abi-Bestand (u. a. Graphen einzeichnen, Lage und Art der Extrempunkte,
maximaler vertikaler Abstand zweier Graphen aus 2018-be-gk, Spurpunkte und
Hessesche Normalform aus 2017-bb-ea, Binomial-Formel/Tabelle und
Mindestanzahl aus 2019/2017). Neue Typen: Teil A 4 (Funktion aus
Stammfunktion, Stammfunktionen mit Abstand, Kollinearität dreier Punkte,
zweiter Punkt gleichen Abstands), 2.1 3 (Art des Extrempunkts am
Ableitungsgraphen, Fläche mit vorgegebener Stammfunktion, parallele Tangenten
über f' = f''), 2.2 4 (Nullstellen aus der faktorisierten Form,
Termgleichheit durch Ausmultiplizieren, Wendepunkt aus dem Extrempunkt des
Ableitungsgraphen, Querschnitt Tangente/Graph zum Volumen), 3.1 1
(Lage zweier Ebenen und Schnittgerade), 3.2 2 (Schnittpunkt mit senkrechter
Kante, Trapezfläche geneigte/waagerechte Ebene), 4.1 2 (spätestens dritter
Erfolg, Behauptung über Augensumme widerlegen), 4.2 1 (Anteil aus dem
Verhältnis zweier Pfade). Etikettenfragen: 2.2 b (Ausmultiplizieren) unter
Gleichungen lösen, weil die Liste kein Thema für Termumformungen hat; 1.4 b
(Spitze über der Basismitte aus dem Flächeninhalt) auf den Pooltyp von
2022-ga-A gelegt.

*Eichung.* 3 von 3 gewerteten Zeilen (Teil-A-Dubletten, geerbt); 48
Landeszeilen ohne amtlichen Bereich. Eigene Schätzungen nach der engen
Fassung: 4 mit III (2.1 j, 2.2 g, 3.2 e, 4.2 g), 27 mit II, 17 mit I.

*Schnitt.* 33 Werte auf 51 Zeilen, 43 Zeilen auf bekannten Werten des
Niveaus grundlegend; **1 Wert neu im Gesamtbestand** (Schnittmengen ·
angeben, 3.1 b Spurpunkte angeben), 3 neu im Niveau (dazu Punkt · angeben,
Stammfunktion und Hauptsatz · angeben); Gesamtbestand 190 Werte (be-gk 156,
bb-ea 177). Von den 48 Landeszeilen liegen 38 auf Werten aus Teil A des
grundlegenden Pools.

*Aufwand.* Etwa 55 Minuten (Textvergleich gegen 16 Pooldateien, sechs
...
**2024-bebb-lk erfasst (17.09.2026, Auftrag B, Teil 1; abi-bau.py v0.8, abi.md
v0.18).** Stark-Band zum Abitur 2027 LK, Jahrgang 2024, Bildscan der 13
Aufgabenseiten (Verlagsseiten 2024-1, -2, -7, -8, -16, -17, -26, -27, -28,
-35, -36, -42, -43; die Lücken sind Tipp- und Lösungsseiten, die Tippseite
2024-28 enthält oben noch 2.2 Aufgabenteil 2 d), gerendert mit pypdfium2
(Lesefassung 0,65). Scanqualität: alle Seiten lesbar, Handschatten und
Durchscheinen ohne Folgen; keine Formel unsicher. **Heftaufbau 2024 LK (aus
dem Heft):** Aufgabe 1 hilfsmittelfreier Teil mit „Pflichtaufgaben" 1.1–1.4
(Analysis, Analysis, Analytische Geometrie, Stochastik; Summe 20) und
„Wahlaufgaben" 1.5–1.10 (je zwei Analysis, Geometrie, Stochastik; Summe 30
angeboten, zwei zu bearbeiten – Schlüssel 2024 LK 30 BE für Teil A); Teil B
2.1/2.2 Analysis je 40 zur Wahl, 3 Geometrie 25, 4 Stochastik 25 (Schlüssel
30 / 40 / 25 / 25 = 120). Das ist bereits der Aufbau ab 2025 (vier Pflicht,
zwei aus sechs Wahl), nur mit dem Schlüssel 2024. 53 Zeilen aus 14 Aufgaben,
alle Punktsummen stimmen (10 × 5, 40, 40, 25, 25). Selbstprüfung beider
Bau-Skripte bestanden (abi 748 Zeilen aus 15 Heften, iqb 1258, 1204 Typen),
Lauf aus dem HEAD-Stand byteidentisch.

*Pool-Abgleich (Text der zehn zugeordneten Pooldateien 2024 erhöht mit pypdf
gegen das Bild gelesen).* Teil A: 1.1 = Analysis 1.2, 1.2 = Analysis 1.3,
1.3 = AG/LA (A2) 1.2, 1.5 = Analysis 2.1, 1.6 = Analysis 2.2, 1.7 = AG/LA
(A2) 2.1, 1.10 = Stochastik 2.2 – alle wortgleich (13 Zeilen); 1.4 (Urne
3 grün/3 rot), 1.8 (Geradenschar zu einer Ebene), 1.9 (defekte Geräte)
Landes. Teil B: 2.1 Exponentialfunktionen (40 BE, 11 Teilaufgaben) ganz
Landes; 2.2 Lesebestätigung = Analysis WTR 2, Aufgabenteil 1 mit **Schar
f_a(x) = ax³ − 4x statt f_{a;b}(x) = ax³ − bx** – a, b abgewandelt (ein
Parameter), c, d wortgleich (Bezeichnung f₁, f₄ statt f, h), e abgewandelt
(h(x) = bx³ − cx mit b, c ∈ IR statt Scharmitglied; Werte 2 und 18 wie im
Pool), Reihenfolge c/d/e gegenüber Pool d/e/c vertauscht; Aufgabenteil 2 a–d
wortgleich; 3 Pyramide = AG/LA (A2) WTR 1 a–h wortgleich, **BE bei c und f
vertauscht (Heft 4/3, Pool 3/4, Summe 25)** – erfasst mit den Heft-BE, im
Vermerk festgehalten (dubletten.py lässt abweichende BE nur mit Vermerk zu);
4 Video-Streamingdienst = Stochastik WTR 1 a–h wortgleich (Stamm „Bei den
über 40-jährigen Abonnenten" statt „Unter denjenigen Abonnenten, die älter
als 40 Jahre sind"). **Poolquote 34 von 53 Zeilen, 110 von 180 BE (61 %)**,
dazu 3 abgewandelte Zeilen (15 BE); Sitz: Teil A 35 von 50 BE, Teil B 2.2
25 + 3 (abgewandelt 15), 3 und 4 vollständig. Kontextgebundene Zeilen: keine.

*Typen.* 55 verwendet, 13 neu (24 %), 41 aus dem iqb-Katalog (davon 34 über
die Dubletten), 4 wiederverwendet in Landeszeilen (genau ein Treffer bei zwei
Versuchen, Graph zum Parametervorzeichen zuordnen, Ableitung eines Produkts
mit e-Funktion nachweisen, Sekantengleichung). Neue Typen: Teil A 4 (drei
aufeinanderfolgende gleichfarbige Kugeln, Kugelzahl für begrenzte
Farbreihenfolgen, Geradenschar zu einer Ebene mit Fallunterscheidung, Fehler
aus der Vereinigung zweier unabhängiger Fehler), 2.1 9 (Grenzverhalten nach
dem Parametervorzeichen, Anzahl der Nullstellen über die Diskriminante,
mögliche Extremstellen aus der faktorisierten Ableitung als Nebentyp,
gleichseitiges Dreieck aus Tangente und Spiegeltangente, Rechenweg zur
Tangente von einem Punkt an den Graphen erläutern, Parameter für einen
Schnittwinkel mit der y-Achse, Nullstellenfreiheit aus dem Tiefpunktwert,
Integral gegen eine Schranke, Fläche am Bild mit Integralwert vergleichen).
Etikettenfragen: 2.2 b behält den Pooltyp „Tiefpunkt einer Schar mit zwei
Parametern …" (gleiche Fertigkeit, ein Parameter weniger); 2.1 k unter
Flächeninhalt durch Integration (Klasse Fläche), nicht Kurvenuntersuchung.

*Eichung.* 33 von 34 gewerteten Zeilen (alle geerbt; die Abweichung 4 c ist
die des Pools). 19 Landes- und abgewandelte Zeilen ohne amtlichen Bereich,
eigene Schätzungen nach der engen Fassung: 3 mit III (2.1 f, g, 2.2 e), 10
mit II, 6 mit I.

*Schnitt.* 36 Werte auf 53 Zeilen, 51 Zeilen auf bekannten Werten des
Niveaus erhöht; **0 Werte neu im Gesamtbestand**, 2 neu im Niveau erhöht
(Integralwert · berechnen; Ziehen ohne Zurücklegen · begründen, das auch
gegen den iqb-Katalog neu ist und nur aus 2021-be-gk bekannt);
Gesamtbestand 190 Werte (be-gk 156, bb-ea 177). Von den 19 Landeszeilen
liegen 16 auf Werten aus Teil A des erhöhten Pools.

*Aufwand.* Etwa 45 Minuten (13 Seiten gerendert gelesen, zehn Pooldateien
...
abitur-abgleich.py v0.21).** Ähnlichkeitssuche über die 91 neuen Typen der Hefte
...
**2017-bb-ea-cas, CAS-Delta (27.09.2026, Auftrag Nacht 2026-09-27, Teil 9).**
Erstes erfasstes Rechnerheft, als Nachtrag zu 2017-bb-ea (abi.md § 7;
abi-bau.py v0.14 mit Nachtragsmodus). Heft hefte/abi/2017-bb-ea-cas.pdf
(BB_17_Ma_CAS_Aufgaben), 10 Seiten wie die WTR-Fassung, jede Aufgabe auf
derselben Seite; Deckblatt „mit CAS“, Hilfsmittel „CAS, das zugelassen und an
der Schule eingeführt ist“ (nicht für Aufgabenstellung 1). Text beider Hefte
mit pdftotext -layout, alle Teilaufgaben nebeneinander verglichen (Skript
vergleich.py im Scratchpad), jede Aufgabenseite gerendert; die Abbildungen
(Eisbecher, Koordinatensystem 2.2 c, Zelt Abb. 1 und 2, Pavillon, Urnen) sind
gleich. **Präfixregel bestätigt:** „CAS:“ tragen 2.1, 2.2, 3.1 und 4.2; die
Aufgaben ohne Präfix – Teil 1 (1.1–1.3, BE 2 + 3 je Aufgabe), 3.2
Gartenpavillon (3 | 2 | 3 | 2) und 4.1 Vereinsjubiläum (2 | 4 | 4) – sind in
jeder Teilaufgabe wortgleich mit gleichen BE; keine Aufgabe ohne Präfix
weicht ab. Je Teilaufgabe (CAS-BE, in Klammern WTR): *2.1 Eisbecher* (CAS
7 | 7 | 13 | 4 | 6 | 6 | 7 = 50 in sieben Teilaufgaben, WTR 8 | 8 | 14 | 4 | 9 |
7 = 50 in sechs): wortgleich mit gleichen BE d (4) und g = WTR f (7);
wortgleich, nur BE gesenkt a (7 statt 8), b (7 statt 8), c (13 statt 14),
f = WTR e Parabel p (6 statt 9); neu e (6, Größe der hellen
Querschnittsfläche des befüllbaren Teils, Fläche zwischen Graph und
waagerechter Randgeraden). *2.2 Straßenverlauf* (CAS 6 | 9 | 9 | 5 | 6 | 10 | 5,
WTR 6 | 10 | 9 | 6 | 10 | 9): wortgleich a (6), c (9), e = WTR d (6), f = WTR e
(10; nur der Rückverweis „aus Teilaufgabe e)“ statt „d)“ nachgeführt); nur BE
gesenkt b (9 statt 10) und g = WTR f Getreidefläche (5 statt 9); neu d (5,
Identität von G_a und G_(−a) begründen, Parameter für R(2 | 4)). *3.1 Zelt*
(CAS 5 | 4 | 4 | 3 | 4 | 5, WTR 5 | 4 | 5 | 3 | 3 | 5): wortgleich a, b, d; c
nur BE (4 statt 5); e mit zusätzlichem Auftrag – y-Koordinate der äußeren
Vordachkante, Kontrollangabe etwa 5,98 (4 statt 3); f gleich bis auf den
Hinweis auf 5,98, der in die Kontrollangabe von e gewandert ist. *4.2
Freizeit* (BE 8 | 4 | 5 | 4 | 4 in beiden): c und e wortgleich; a Ereignis C
„unter 100 mehr als 78 und weniger als 92“ statt „unter 20 mehr als 18“; b
umgekehrt – höchstens n mit P unter 98 % statt mindestens n mit mindestens
98 % (12 statt 13); d Stammangabe 6 % statt 5 % Stornierungen (Modalwert 10
statt 9); e rechnet nicht mit dem Anteil und bleibt gleich. **Zeilen:** 14
(2.1 a, b, c, e, f; 2.2 b, d, g; 3.1 c, e, f; 4.2 a, b, d), 87 BE; jede trägt
„CAS-Nachtrag zu <WTR-id> (WTR): …“ bzw. „CAS-Nachtrag, ohne WTR-Gegenstück:
…“ und „Eigene Rechnung“. **Messung** über die 185 angebotenen BE (Klassen
wie beim Paar oben): wortgleich mit gleichen BE 98 BE (53 %: 35 in Aufgaben
ohne Präfix, 63 in „CAS:“-Aufgaben); gleicher Typ, gleicher Wortlaut, nur BE
gesenkt – der Rechenweg geht ans CAS – 51 BE (28 %: 2.1 a, b, c, f, 2.2 b, g,
3.1 c); gleicher Typ, andere Angaben oder andere Frage 25 BE (14 %: 3.1 e, f,
4.2 a, b, d; in 3.1 e eine Nebenleistung mehr); zusätzliche Teilaufgaben mit
anderem Typ 11 BE (6 %: 2.1 e, 2.2 d). Keine WTR-Leistung entfällt; die BE,
die das CAS an Rechnungen spart (−11 in 2.1 und 2.2, −1 in 3.1 c), gehen in
die beiden neuen Teilaufgaben (+11) und in 3.1 e (+1). **Typen:** 27
verwendet, 1 neu („Identische Graphen einer Schar zu entgegengesetzten
Parameterwerten begründen“, 2.2 d); 2.1 e nutzt „Fläche: Fläche zwischen zwei
Graphen als Integral der Differenz berechnen“ (Pool), 4.2 b den Typ
„Mindestanzahl von Versuchen …“ mit umgekehrter Frage (Etikett im Bericht zur
Umbenennung vorgeschlagen). **Neue Schnittwerte: 0** – alle 9 Schnittwerte
der Zeilen stehen im erhöhten Bestand. Muster wie beim Berliner Paar: das
CAS senkt die BE rechenlastiger Teilaufgaben, verschiebt Fragen ins Größere
(n = 100 statt 20, Intervall statt Einzelsumme) oder dreht sie um und setzt
kleine Begründungsaufgaben dazu; die Fertigkeiten bleiben im Typenvorrat.
**Poolbefund:** 3.1 Zelt ist wortgleich die Poolaufgabe 2017 erhöht Teil B
AG/LA (A2) CAS 2 (2017MerhoehtBAGLAA2CAS2, hefte/iqb/, BE 5 | 4 | 4 | 3 | 4 |
5); die Zeilen 3.1 c, e, f tragen „Poolaufgabe (nicht erfasst):
2017MerhoehtBAGLAA2CAS2-1c“ (-1e, -1f). Ihr Stapel 2017-ea-B, CAS-Zweig (6
Dateien, iqb-pruefungen.md § 2: Reserve, „CAS ist die MMS-Fassung bis 2021“),
ist nicht erfasst. Nach der Regel „Eine Vormerkung überlebt keinen Auftrag“
(abi.md § 7) wäre er im selben Auftrag zu erfassen; der Auftrag Teil 9
beschränkt die Änderungen auf abi-Dateien – **offener Posten, gemeldet**
(3 Vormerkungen; die Selbstprüfung von iqb-bau.py zählt „2017-ea-B-cas 3“).
Die Schätzung der drei Zeilen stammt aus den WTR-Zeilen; wo der Standardbezug
der Poolfassung abweicht, gilt er (Vorrang des Amtlichen, Kern § 5): c und e
II statt III, f III wie gehabt; afb_amtlich bleibt bis zum Verweis leer.
**Folge für 2017-bb-ea:** die WTR-Aufgabe 3.1 Zelt ist die WTR-Fassung dieser
CAS-Poolaufgabe – a, b, d wortgleich (12 BE), c, e, f abgewandelt (BE 5 | 3 | 5,
f mit 5,98 als Angabe). Der Pool-Abgleich des Bestands (Lauf 14, § 4 Tabelle
„2017-bb-ea | Teil B 2.1–4.2 | kein Treffer“) hat nur die WTR-Pooldateien
durchsucht. Die WTR-Zeilen 2017-bb-ea-B3.1a–f tragen deshalb keinen
Poolvermerk; die Poolquote von 2017-bb-ea stiege mit Vormerkungen von 15 auf
27 von 185 BE wortgleich (15 %) und 13 BE abgewandelt. Nicht geändert: das
geht nur über abitur-abgleich.py (Abgleichlauf) und zusammen mit dem Stapel.
Suche nach den Kontexten aller vier „CAS:“-Aufgaben in allen 24 Dateien des
Pools 2017 Teil B (WTR und CAS, beide Niveaus): sonst kein Treffer
...
**2017-be-gk-cas, CAS-Nachtrag (29.09.2026, Auftrag Nacht 2026-09-29, Teil 4;
Beschluss vom 26.09.2026 Punkt 3).** Erstes Berliner Rechnerheft, als Nachtrag
zu 2017-be-gk; Grundlage ist die Messung in befund-cas-berlin-2026-09-28.md
(Art je Teilaufgabe). Heft hefte/abi/2017-be-gk-cas.pdf (17_Ma_GK_CAS_Aufgaben),
8 Seiten wie die WTR-Fassung, aber ohne die Anlage zu 3.2 (Tafel der summierten
Binomialverteilung): 1.1 steht auf Seite 2–3, 1.2 auf 4, 2.1 auf 5, 2.2 auf 6,
3.1 auf 7, 3.2 auf 8 – eine Seite später als im WTR-Heft. Text mit pdftotext
-layout, jede Aufgabenseite gerendert; die Abbildung zu 1.1 e (Holzbrett
zwischen g_u und g_o, Stütze am rechten Rand 3 cm breit) steht nur in der
CAS-Fassung und trägt die Lage der Stütze, die 1.1 f braucht. **Regel** (Beschluss
Punkt 3): eigene Zeile für die Arten Werkzeug, Auftrag, Zuschnitt, ganze
Aufgabe; nur BE oder nur Zahl als Landes-Dublette „Dublette von: <WTR-id>.“ mit
Vermerk (abi-bau.py v0.15); wortgleiche Teilaufgaben mit gleichen BE übernommen.
**Zeilen:** 16 von 16 abweichenden Teilaufgaben (Befund: 16, davon nur BE 5),
86 BE. *Eigene Zeilen (11):* 1.1 a (Werkzeug: Kontrollangabe f′ entfällt, 8
statt 9 BE), 1.1 e (ganze Aufgabe: Lage des Graphen zwischen g_u und g_o,
kleinster vertikaler Abstand 2 cm bei x = 5; neuer Typ), 1.1 f (Auftrag: Volumen
des grauen Brückenteils mit Stütze, 23231/90 ≈ 258,1 cm³ statt 400 cm³; Verweis
auf WTR d), 1.2 a (Zuschnitt: Achsenschnittpunkte aus WTR a und Graph aus WTR b;
Verweis auf WTR b), 1.2 b (Zuschnitt, Auftrag, Werkzeug: Ableitung mit
Ableitungsregeln, Extrempunkte aus WTR a ohne Kontrollangabe, dazu zwei
Wendepunkte bei 3 ± √2; Verweis auf WTR a), 1.2 d (Werkzeug: Stammfunktion
weder vorgegeben noch nachzuweisen), 1.2 f (ganze Aufgabe: Punkt Q mit Gefälle
45°, Q ≈ (0,41 | 0,23)), 2.2 c (Auftrag: Winkel zwischen Seitenwand ABFE und
Deckelfläche EFS, γ ≈ 136,3° als stumpfer Innenwinkel), 3.1 e und g (Zahl und
Auftrag), 3.2 d (Auftrag: genau fünf Werte i = 9 … 13 mit P > 10 %, Behauptung
trifft zu; neuer Typ). *Landes-Dubletten (5, alle nur BE):* 1.1 b (4 statt 6),
1.1 c (5 statt 6), 1.2 e (7 statt 9), 2.2 d (3 statt 4), 3.2 c (4 statt 5) –
Felder der WTR-Zeile, Seite und BE des CAS-Hefts; 3.2 c ohne Anlage (Tafel), die
kumulierte Wahrscheinlichkeit liefert der Rechner, der Befund führt die
Teilaufgabe als nur BE. *Übernommen:* 1.1 d = WTR e, 1.2 c, g = WTR c, f, 2.2 a,
b, e, 3.1 a–d, f, 3.2 a, b, e (54 BE); 2.1 unverändert (20 BE). WTR 1.1 f
(Rekonstruktion g(x) = ax³ + bx² + c) hat kein CAS-Gegenstück (Hinweis des
Skripts). **Pool:** 3.1 Smartphone ist wortgleich die CAS-Poolfassung
2017MgrundlegendBStochastikCAS (Stapel 2017-ga-B-cas, erfasst 29.09.2026); 3.1 e
und g, die vom WTR-Heft abweichen, tragen „Dublette von: …CAS-2c/-2e.“ (typ der
Poolzeile, afb_amtlich aus der AB-Spalte I und III, Schätzung I und III wie der
amtliche Bereich), danach den Nachtragsvermerk; keine Vormerkung. Suche nach
den Kontexten der übrigen Aufgaben (Holzeisenbahn, Brückenteil, Dachelement,
Schokotrüffel, Pyramidenstumpf, Glücksrad) im Text aller 98 Pooldateien 2017
und 2018 unter hefte/iqb/: kein Treffer außer anderen Glücksrad- und
Pyramidenaufgaben. **Typen:** 27 verwendet, 2 neu („Lage eines
Graphen zwischen zwei Geraden auf einem Intervall über die Differenzfunktionen
nachweisen“, 1.1 e; „Trefferzahlen mit einer Einzelwahrscheinlichkeit über einer
Schranke mit dem Rechner ermitteln“, 3.2 d); Nebentyp von 1.1 e ist „Maximalen
vertikalen Abstand zweier Graphen über die Differenzfunktion nachweisen“,
obwohl das Minimum gesucht ist (Abgleichlauf 28). Anderer Haupttyp als die
WTR-Zeile: 1.2 b (Ableitung, erste Leistung), 1.2 d (Fläche statt Nachweis der
Stammfunktion), 2.2 c (stumpfer Winkel zweier Nachbarflächen, Pooltyp aus
2017MerhoehtBAGLAA2CAS2-1b), 3.1 e, g (Pooltypen), 3.2 d (neu). **Muster:** wie in
Brandenburg senkt das CAS die BE rechenlastiger Teilaufgaben (1.1 b, c; 1.2 e;
2.2 d; 3.2 c) und streicht vorgegebene Zwischenergebnisse (f′ in 1.1 a und 1.2 b,
F in 1.2 d); anders als Brandenburg verteilt Berlin Aufträge neu (1.2 a, b) und
ersetzt Aufgaben ganz (1.1 f der WTR-Fassung entfällt, 1.1 e und 1.2 f sind neu).
Kennzahlen § 2; Pool 2 von 16 Zeilen, 6 von 86 BE.

**2017-be-lk-cas, Nachtrag geprüft (29.09.2026, Auftrag Nacht 2026-09-29,
Teil 4; Beschluss vom 26.09.2026 Punkt 3).** Keine Zeile. Das Heft
(hefte/abi/2017-be-lk-cas.pdf, 17_Ma_LK_CAS_Aufgaben_neu, 9 Seiten) hat nach
der Messung (befund-cas-berlin-2026-09-28.md) 19 abweichende Teilaufgaben,
davon 9 nur BE. **Schon Zeile eines Brandenburger CAS-Hefts (9, Verweis nach
abi.md § 7 wie bei einem Zwilling des anderen Landes, keine zweite Zeile):**
1.2 Straßenverlauf = 2017-bb-ea-cas 2.2 – 1.2 b → 2017-bb-ea-cas-B2.2b (nur BE),
1.2 d → 2017-bb-ea-cas-B2.2d (ganze Aufgabe), 1.2 g → 2017-bb-ea-cas-B2.2g (nur
BE); 2.2 Zelt = 2017-bb-ea-cas 3.1 – 2.2 c → 2017-bb-ea-cas-B3.1c (nur BE),
2.2 e → 2017-bb-ea-cas-B3.1e (Werkzeug), 2.2 f → 2017-bb-ea-cas-B3.1f
(Werkzeug); 3.2 Freizeit = 2017-bb-ea-cas 4.2 – 3.2 a → 2017-bb-ea-cas-B4.2a
(Zahl), 3.2 b → 2017-bb-ea-cas-B4.2b (Auftrag), 3.2 d → 2017-bb-ea-cas-B4.2d
(Zahl). Die übrigen Teilaufgaben dieser drei Aufgaben sind wortgleich mit der
WTR-Fassung und stehen über 2017-bb-ea im Katalog. **Eigene Berliner Aufgaben
ohne WTR-Zeile (10 abweichende Teilaufgaben, nicht erfasst):** 1.1
Verbindungsbrücke a (Werkzeug + Auftrag), b, c, f, g (nur BE), e (ganze
Aufgabe); 2.1 Solarmodule b (nur BE), c (Auftrag); 3.1 Autopanne b (nur BE),
c (Zahl) – die WTR-Aufgaben 2017-be-lk 1.1, 2.1, 3.1 sind selbst nicht erfasst
(§ 2, § 4 oben „die Zwillingsannahme trägt nur zur Hälfte“); offener Posten in
...
§ 4) stehen die Verweise auf AG/LA (A2) CAS 2 (2017MerhoehtBAGLAA2CAS2, BE 5 |
4 | 4 | 3 | 4 | 5). Heft- und Pooltext mit pdftotext -layout nebeneinander
gelesen (hefte/abi/2017-bb-ea.pdf, 2017-bb-ea-cas.pdf,
hefte/iqb/2017MerhoehtBAGLAA2CAS2.pdf): Beide Brandenburger Hefte haben im
Stamm vor e den Satz „Dieses Dreieck liegt in der Ebene F: 39y + 25z = 195.“,
der Pool nicht; sonst stimmen Stamm und Aufträge a–d überein (Pool „Punkts“
statt „Punktes“). *2017-bb-ea-cas* (die drei Vormerkungen): 3.1 c wortgleich →
„Dublette von: 2017MerhoehtBAGLAA2CAS2-1c.“ (afb_amtlich II, die Schätzung II
stand schon auf dem amtlichen Bereich); 3.1 e und f bis auf die Ebene F
wortgleich → „Abgewandelt von: <id>; im Aufgabenstamm zusätzlich die Ebene F,
für die Lösung nicht nötig.“ (Entscheidung des Auftraggebers: streng wortgleich
heißt Dublette, ein zusätzlicher Satz ist eine Abweichung; afb_amtlich leer,
die Schätzungen II und III bleiben). *2017-bb-ea* (WTR-Fassung des Landes,
bisher ohne Vermerk, weil der Pool-Abgleich in Lauf 14 nur die WTR-Pooldateien
durchsucht hat): 3.1 a, b, d wortgleich mit gleichen BE → „Dublette von:“
(afb_amtlich I, II, III; d zieht die Schätzung II auf III nach, Vorrang des
Amtlichen, Kern § 5); 3.1 c Wortlaut gleich, 5 statt 4 BE → ebenfalls
„Dublette von:“ mit den BE in bemerkung (abi.md § 7: eine Dublette darf andere
BE haben; Entscheidung des Auftraggebers, die erste Vorgabe „Abgewandelt von:“
ist zurückgenommen), afb_amtlich II, Schätzung III → II nachgezogen; e
verlangt nur den Nachweis 2,14 m ohne die y-Koordinate (3 statt 4 BE), f gibt
y = 5,98 als Angabe vor, beide mit der Ebene F → „Abgewandelt von:“.
Typvergleich: acht Paare gleich (fünf Dubletten, vier abgewandelte Fassungen,
zusammen neun Zeilen). 3.1 b trug „Neigungswinkel einer Ebene gegen
eine Koordinatenebene über die Normalenvektoren berechnen“, gefragt ist aber der
stumpfe Winkel zweier benachbarter Zeltwände; nach Kern § 6 übernimmt die
Landeszeile den Typ der Poolzeile („Stumpfen Winkel zwischen zwei benachbarten
Seitenflächen einer Pyramide über die Normalenvektoren berechnen“; abi-bau.py
verlangt bei „Dublette von:“ den geteilten Typ), typ_neben (Ebenengleichung der
Nachbarwand) bleibt als Nebenleistung des Landeshefts. **Kennzahlen:**
Poolquote 2017-bb-ea 6 → 10 von 36 Zeilen, 15 → 32 von 185 BE (17 %),
abgewandelt 2 Zeilen, 8 BE; 2017-bb-ea-cas 1 von 14 Zeilen, 4 von 87 BE der
Nachtragszeilen (5 %), abgewandelt 2 Zeilen, 9 BE – aufs ganze Heft 31 von 185
BE wortgleich (17 %: Teil 1 15, 3.1 a, b, d über die WTR-Zeilen 12, c 4) und
9 BE abgewandelt. Eichung über den abi-Bestand 329 von 350 → 334 von 355
gewerteten Zeilen (94 %), Zeilen ohne Maßstab 505 → 500. Offen bleibt im
Bestand nur die Vormerkung 2018-bb-ea-cas 3.1 f (Stapel 2018-ea-B-cas wegen der
Eichschranke nicht erfasst, iqb-pruefungen.md § 4); die WTR-Zeilen
2018-bb-ea-B3.1 a–f bleiben ohne Verweis. Den Typabgleich nach den beiden
Stapeln (vier Zusammenziehungen, neun Umbenennungen) und die Liste alt → neu
führt § 5.

**Abgleichlauf 27 – Verweise 3.1 Museum 2018 (29.09.2026, Auftrag Nacht
2026-09-29, Teil 3 Punkt 4; abitur-abgleich.py v0.28).** Nach dem Delta-Stapel
2018-ea-B-cas (erfasst mit dokumentierter Unterschreitung der Eichschwelle,
iqb-pruefungen.md § 4) stehen die Verweise auf AG/LA (A2) CAS 1
(2018MerhoehtBAGLAA2CAS1, BE 4 | 3 | 4 | 4 | 3 | 7). Heft- und Pooltext
nebeneinander gelesen (pdftotext -layout von hefte/abi/2018-bb-ea.pdf,
2018-bb-ea-cas.pdf und hefte/iqb/2018MerhoehtBAGLAA2CAS1.pdf, dazu die
...
Horizontale.“ (redaktionell). *2018-bb-ea* (WTR-Fassung des Landes, bisher ohne
Vermerk, weil der Pool-Abgleich in Lauf 14 nur die WTR-Pooldateien durchsucht
hat): 3.1 a, b, d wortgleich, e bis auf „Gerade durch die Punkte A und G“ statt
„Gerade AG“ → „Dublette von:“ (afb_amtlich II, I, II, I; b und e ziehen die
Schätzung II auf I nach, Vorrang des Amtlichen, Kern § 5); 3.1 c Auftrag gleich
(„auf der Seite“ statt „zur Seite“), 5 statt 4 BE und im Heft die Kontrollangabe
h_EF ≈ 21,21 m, die im Pool fehlt → „Dublette von:“ mit BE-Vermerk (abi.md § 7;
Vorgabe des Auftrags wie 2017-bb-ea 3.1 c in Lauf 25), afb_amtlich II, Schätzung
II bleibt; 3.1 f umformuliert, mit vorgegebener Ebenengleichung 2x − 2y − z = −75
und 6 statt 7 BE → „Abgewandelt von:“ (afb_amtlich leer, Schätzung III, AB der
Poolzeile III). *2018-bb-ea-cas* (die Vormerkung): 3.1 f Angaben und Auftrag
gleich, Wortlaut umformuliert, 6 statt 7 BE → „Abgewandelt von:“ (ein Heft, das
umformuliert und andere BE hat, ist nicht streng wortgleich; Landesheftabgleich
im Arbeitsstand abitur/arbeitsstand/2018-ea-B-cas/); der CAS-Nachtragsvermerk
steht dahinter. Typvergleich: alle sieben Paare gleich. **Kennzahlen:** Poolquote
2018-bb-ea 4 → 9 von 41 Zeilen, 10 → 29 von 185 BE (16 %), abgewandelt 1 Zeile,
6 BE; 2018-bb-ea-cas 1 → 0 von 14 Zeilen wortgleich (die Vormerkung zählte als
Pool), abgewandelt 1 Zeile, 6 BE. Eichung über den abi-Bestand 335 von 355 → 340
von 360 gewerteten Zeilen (94 %), Zeilen ohne Maßstab 500 → 495. Offene
Vormerkungen im Bestand: keine mehr. Typabgleich nach dem Stapel (eine
Zusammenziehung, neun Umbenennungen, vier erweiterte Definitionen; im abi-Katalog
zwei Zeilen: 2018-be-gk-B1.1e und 2022-bebb-gk-B2.2k tragen jetzt
„Funktionsgleichung aus knickfreiem Übergang rekonstruieren“) und die Liste alt →
neu führt § 5.
...
(abitur-abgleich.py v0.22) den 21 Dubletten der Hefte bis 2018 afb_amtlich aus der
...
| 2023-bebb-gk | 14 (2023-1 bis -4, -13 bis -15, -23 bis -25, -31 f., -38 f.; Bildscan) | 58 / 58 | 0 | 52 | 1 | 10 (347 KB) | 19.3 KB | 30 min | Corona-Aufbau: hilfsmittelfreier Teil mit sieben unnummerierten Einheiten (Analysis 1–3, Analytische Geometrie 1–2, Stochastik 1–2) = 1.1–1.7 in Heftreihenfolge wie im Katalog; Aufgabe 4 Aufgabenteil 1 = 4.1, Teil 2 = 4.2. Eine Abweichung: das Katalogfeld ergebnis von 2.1 c (und der Vergleichswert in 2.1 d) rundet f(−1 + √5) = −4,2546 auf −4,26 statt −4,25 – Feldkorrektur im nächsten Abgleichlauf, nicht von Hand. Das Heft druckt bei 2.1 l ein Integral mit Grenzen 0 und 2 und zugleich „+ C" (Druckfehler; so übernommen und im Markdown vermerkt). Begründungsaufgaben 1.1 a, 1.2 b, 1.7 b, 2.1 d/h/m, 2.2 e/f, 3 b/f/h, 4.1 e, 4.2 a/b gelesen, stimmig. Stichproben: 1.7 b, 2.1 h, 2.2 f, 3 h, 4.2 b |
| 2023-bebb-lk | 14 (2023-1 bis -3, -11 bis -13, -20 bis -22, -31 f., -39 bis -41; Bildscan) | 66 / 66 | 0 | 57 | 0 | 9 (134 KB) | 24.4 KB | 35 min | Corona-Aufbau: hilfsmittelfreier Teil mit acht unnummerierten Einheiten (Analysis 1–4, Analytische Geometrie 1–2, Stochastik 1–2) = 1.1–1.8 wie im Katalog; 2.2 Aufgabenteil 2 a–g = h–n, 4 Aufgabenteil 2 a–f = g–l. Randfrage ohne Wertung als Abweichung: 3 e – der Katalog nennt die offene Strecke 1/3 < t < 1 (an den Enden enthält N eine Kante), rechnerisch erfüllen auch t = 1/3 und t = 1 die Bedingung, wenn ein Kantenendpunkt als gemeinsamer Punkt zählt. Begründungsaufgaben 1.1 a, 1.5 b, 1.6 b, 2.1 c/g/l, 2.2 a/g, 2.2 Teil 2 a/c/f, 3 c/g/k, 4 b/e/f gelesen, stimmig. Stichproben: 1.1 a, 2.1 g, 2.2 Teil 2 f, 3 k, 4 f |
| 2022-bebb-gk | 12 (2022-1 f., -9 f., -18 f., -28 f., -37 f., Anlage -39 f.; Bildscan) | 57 / 57 | 0 | 51 | 0 | 6 (74 KB) | 18.4 KB | 25 min | Corona-Aufbau: hilfsmittelfreier Teil mit sieben unnummerierten Einheiten = 1.1–1.7 wie im Katalog; 2.1 Aufgabenteil 2 a–d = j–m. Anlage (summierte Binomialverteilung n = 100, Seiten 2022-39 f.) nicht übertragen, nur im Kopf vermerkt. BE-Spalte der Seite 2022-10 im Scan angeschnitten (p4_rand.jpg), Werte 4/3/3/2/5 lesbar und gleich Katalog. Begründungsaufgaben 1.2 b, 1.4 b, 1.6 b, 2.1 c/f/i, 2.1 Teil 2 c, 2.2 c/d/j, 3 e/g/h/i, 4 a/g gelesen, stimmig. Stichproben: 1.4 b, 2.1 f, 2.2 d, 3 h, 4 a |
| 2022-bebb-lk | 15 (2022-1 bis -3, -12 f., -22 bis -24, -33 f., -43 bis -45, Anlage -46 f.; Bildscan) | 68 / 68 | 0 | 58 | 1 | 10 (132 KB) | 21.6 KB | 40 min | Corona-Aufbau: hilfsmittelfreier Teil mit acht unnummerierten Einheiten = 1.1–1.8 wie im Katalog; 2.2 Aufgabenteil 2 a–g = i–o, 4 Aufgabenteil 2 a–b = g–h, Aufgabenteil 3 a–e = i–m. Anlage (Binomialtabelle n = 100, Seiten 2022-46 f.) nicht übertragen. Eine Abweichung: 4.1 d fragt im Heft nach „höchstens 50 %" (P(X ≤ 50) ≈ 0,043), die Katalogzeile B4d folgt der Poolzeile 2022MerhoehtBStochastikWTR1-1d („mehr als 50 %", P(X > 50) ≈ 96 %) und nennt die Zeile wortgleich – der Wortlaut weicht ab (Landesfassung oder Verlagsdruckfehler; am Pool-PDF geprüft: dort „mehr als"). Zu klären im nächsten Abgleichlauf (Vermerk „Abgewandelt von:" und Ergebnisfeld), nicht von Hand. mdcheck.py: e^{…} mit geschachtelten Klammern wird jetzt korrekt nach exp() übersetzt (frühere Hefte davon nicht betroffen, alle Prüfungen liefen mit einfachen Exponenten). Begründungsaufgaben 1.2 a, 1.4 b, 1.5 a, 1.8 b, 2.1 e/g/k, 2.2 a/c/e/h, 2.2 Teil 2 c/e/f, 3 a/b/i, 4 c/f, 4 Teil 2 a/b, 4 Teil 3 b gelesen, stimmig. Stichproben: 1.8 b, 2.1 k, 2.2 h, 3 i, 4 Teil 2 b |

**Teil 1 abgeschlossen (17.09.2026).** Der Markdown-Korpus umfasst alle zehn
Verlagshefte 2022–2026 beider Niveaus: 2025-bebb-gk (Auftrag B) und die neun
Hefte der Tabelle, zusammen 529 Teilaufgaben, 198,4 KB Markdown, 94 Abbildungen
(1,7 MB) in hefte-md/ außerhalb des Repos. Struktur und BE: 529 von 529 gleich
dem Katalog, keine Abweichung. Ergebnisse: 451 rechnerische Teilaufgaben mit
sympy aus den Markdown-Termen nachgerechnet; zwei Abweichungen im Katalogfeld
ergebnis, beide ohne Handedit stehen gelassen und für den nächsten Abgleichlauf
vorgemerkt: 2023-bebb-gk-B2.1c (Rundung −4,26 statt −4,25) und 2022-bebb-lk-B4d
(Ergebnis der Poolzeile „mehr als 50 %" übernommen, das Heft fragt „höchstens
50 %"; Vermerk „Dublette von:" für diese Teilaufgabe nicht wortgleich). Das
Abbruchkriterium (mehr als zwei Abweichungen in einem Heft) wurde in keinem Heft
erreicht. Ein Übertragungsfehler der Abschrift (2025-bebb-lk 1.10) wurde von der
Prüfung abgefangen und berichtigt. Aufwand gesamt etwa 4,5 Stunden für neun
Hefte (22–40 Minuten je Heft; Textebene schneller als Bildscan). Werkzeuge im
...
(Auftrag C, Teil 2, 17.09.2026; abitur-abgleich.py v0.23).** Die 35 Vormerkungen
...
25, Auftrag „Weg A umsetzen", 15.09.2026).** Grundlage befund-abi-iqb-typen.md
(Messung vom selben Tag). Zwei Commits: erst abitur-vokabular.md, abitur-abgleich.py
...
Entscheidung 26; abitur-abgleich.py v0.13, abi-bau.py v0.4, iqb-bau.py v1.1,
...
Bestand) und in abitur-abgleich.py nach jedem Lauf; der Schnitt wird über das Thema
des Typs gemessen.
...
| Datum | Änderung |
|---|---|
| 2026-09-29 | Abgleichlauf 28 (abitur-abgleich.py v0.29; Auftrag Nacht 2026-09-29, Teil 4 Punkt 6) nach dem Delta-Stapel 2017-ga-B-cas und den Nachträgen 2017-be-gk-cas, 2018-be-gk-cas: 11 neue Typen abgeglichen, keine Zusammenziehung; vier Umbenennungen neutral zur Verwendung, im abi-Katalog – „Maximalen vertikalen Abstand zweier Graphen über die Differenzfunktion nachweisen“ → „Größten oder kleinsten vertikalen Abstand zweier Graphen über die Differenzfunktion bestimmen“ (2018-be-gk-B1.1g, 2020-be-gk-B2.1g, 2021-be-gk-B2.2i, 2024-bebb-gk-B2.2g, 2018-be-gk-cas-B1.2g; typ_neben 2017-be-gk-cas-B1.1e, 2018-be-gk-cas-B1.1g); „Länge des Zeitraums mit Mindeständerungsrate über die Lösungen von f'(x) = c berechnen“ → „Zeitraum mit einer Mindest- oder Höchständerungsrate über die Lösungen von f'(x) = c bestimmen“ (2022-bebb-gk-B2.1m); „Stumpfen Winkel zwischen zwei benachbarten Seitenflächen einer Pyramide über die Normalenvektoren berechnen“ → „Stumpfen Winkel zwischen zwei benachbarten Seitenflächen eines Körpers über die Normalenvektoren berechnen“ (2017-bb-ea-B3.1b, 2017-be-gk-cas-B2.2c); „Fehlerwahrscheinlichkeit einer Einheit binomial berechnen und als Trefferwahrscheinlichkeit einer zweiten Binomialverteilung verwenden“ → „Wahrscheinlichkeit für eine Einheit binomial berechnen und als Trefferwahrscheinlichkeit einer zweiten Binomialverteilung verwenden“ (2021-be-gk-B4d; typ_neben 2017-be-gk-cas-B3.2d); zwei erweiterte Definitionen (abschnittsweise begrenzte Fläche, Volumen mit konstantem Querschnitt); Feldkorrektur 2018-be-gk-cas-B1.2e: Nebentyp „Intervall, in dem eine Modellfunktion mindestens einen vorgegebenen Wert annimmt, über eine Ungleichung bestimmen“ → „Zeitraum mit einer Mindest- oder Höchständerungsrate über die Lösungen von f'(x) = c bestimmen“ (Gegenstand Änderungsrate). 12 abi-Zeilen, 7 iqb-Zeilen (vollständige Liste in iqb-pruefungen.md § 5); Typen 1421 → 1421. Vermerke in bemerkung, die das alte Etikett nennen (2017-be-gk-cas 1.1 e, 2.2 c), bleiben als Erfassungsbefund stehen. Lauf aus einer frischen Repo-Kopie byteidentisch; Selbstprüfung beider Bau-Skripte bestanden. abi.md v0.31 (§ 4, § 7, § 9). |
...
| 2026-09-29 | Abgleichlauf 26 (abitur-abgleich.py v0.27; Auftrag Nacht 2026-09-29, Teil 2): Deutungsliste Eintrag (f) (iqb.md v1.17 § 7); im abi-Katalog zieht die wortgleiche Landeszeile 2024-bebb-lk-B4c mit ihrer Poolzeile 2024MerhoehtBStochastikWTR1-1c von II auf III nach (Grund in bemerkung); sonst keine abi-Zeile geändert, Typen unverändert (1393). Eichung abi 334 → 335 von 355. Nicht angefasst: Landeszeilen ohne Maßstab mit einer (f)-Leistung (2017-bb-ea-B4.2b, 2019-be-gk-B4.1b, 2020-be-gk-B4.1c, 2021-be-gk-B4e, 2022-bebb-gk-B4d, 2023-bebb-gk-B4.1f, alle II) – der Auftrag begrenzt die Bestandsprüfung auf Poolzeilen, die Eichschranke gilt für Landeshefte nicht (iqb.md § 7). Details iqb-pruefungen.md § 5. |
| 2026-09-28 | Abgleichlauf 25 (abitur-abgleich.py v0.26; Auftrag Nacht 2026-09-28, Teil 2 Punkt 4) nach den Reserve-Stapeln 2017-ea-B (WTR) und 2017-ea-B-cas. **(a) Verweise** (9 Zeilen, Abbruch bei anderer Zahl): 2017-bb-ea-cas 3.1 c „Poolaufgabe (nicht erfasst)“ → „Dublette von: 2017MerhoehtBAGLAA2CAS2-1c.“, 3.1 e, f → „Abgewandelt von: …-1e/-1f; im Aufgabenstamm zusätzlich die Ebene F, für die Lösung nicht nötig.“; 2017-bb-ea 3.1 a, b, c, d neu „Dublette von:“ (…-1a bis -1d; c mit „5 statt 4 BE“ in bemerkung nach abi.md § 7 – Entscheidung des Auftraggebers, die erste Vorgabe „Abgewandelt von:“ zurückgenommen; Schätzung nach dem amtlichen Bereich c III → II, d II → III), 3.1 e, f neu „Abgewandelt von:“ (e nur der Nachweis 2,14 m, 3 statt 4 BE; f y = 5,98 vorgegeben; beide mit Ebene F); Poolquote 2017-bb-ea 10 von 36 Zeilen, 32 von 185 BE, abgewandelt 2 Zeilen, 8 BE; Eichung über den abi-Bestand 334 von 355; Typvergleich acht Paare gleich, 2017-bb-ea 3.1 b vom Etikett „Neigungswinkel einer Ebene gegen eine Koordinatenebene über die Normalenvektoren berechnen“ auf den Pooltyp „Stumpfen Winkel zwischen zwei benachbarten Seitenflächen einer Pyramide über die Normalenvektoren berechnen“ umgestellt (Kern § 6, geteilter Typ; Befund in § 4). **(b) Typabgleich** der 53 neuen Typen beider Stapel gegen alle Typen derselben Leitidee (Wortmenge von Name und Definition, Zeichenfolge; Kandidaten an gegeben, gesucht, verfahren geprüft) und der Etikettenvorschläge aus iqb-pruefungen.md § 4; Typenliste 1398 → 1393. **Zusammenziehungen:** „Maximumstelle aller Stammfunktionen über den Vorzeichenwechsel des Integranden begründen“ (iqb 2019MgrundlegendBAnalysisWTR2-1e) + „Extremstelle aller Stammfunktionen über den Vorzeichenwechsel der gegebenen Ableitung begründen“ (abi 2026-bb-gk 2.1 b, 2026-bb-ea 2.1 e) + „Extrempunkt einer Integralfunktion ohne Rechnung über den Vorzeichenwechsel des Integranden begründen“ (iqb 2017MerhoehtBAnalysisWTR2-1i) → „Extremstelle einer Stammfunktion über den Vorzeichenwechsel des Integranden begründen“ (F′ = f wechselt das Vorzeichen, ob für alle Stammfunktionen oder eine Integralfunktion); „Parameter einer Linearkombination aus Funktion und Gerade aus zwei Punkten bestimmen“ (abi 2025-bebb-lk 1.2 b, iqb 2025MerhoehtAAnalysis13-b) + „Zwei Parameter einer Exponentialfunktion aus zwei Punktbedingungen über ein lineares Gleichungssystem bestimmen“ (iqb 2017MerhoehtBAnalysisWTR3-2h) → „Zwei linear eingehende Parameter eines Funktionsterms aus zwei Punkten bestimmen“ (Einsetzen, lineares Gleichungssystem); „Fläche: Wasservolumen in einer Mulde aus Fläche zwischen Wasserlinie und Graph mal Breite berechnen“ (iqb 2025MerhoehtBAnalysisMMS2-2c, 2017MgrundlegendBAnalysisWTR-1i, 2017MerhoehtBAnalysisWTR3-2d) + „Fläche: Volumen eines Körpers mit konstanter Tiefe aus der Fläche zwischen Graph und x-Achse berechnen“ (abi 2017-be-gk 1.1 d) → „Fläche: Volumen eines Körpers mit konstantem Querschnitt aus der Fläche zwischen Graph und waagerechter Gerade berechnen“ (Vorschlag des WTR-Stapels, erweitert: die x-Achse ist eine waagerechte Gerade); „Transformation: Streckungen in x- und y-Richtung aus einer Funktionalgleichung f2(x) = a · f1(bx) beschreiben“ (iqb 2017MerhoehtBAnalysisWTR2-1h) → „Transformation: Abbildung zwischen zwei Graphen angeben“ (bestehender Name, Definition erweitert). **Umbenennungen** (neutral zur Verwendung, Definition angepasst): „Tangente im Ursprung als Gerade durch zwei Punkte nachweisen“ → „Tangente an einer Stelle als Gerade durch zwei Punkte nachweisen“ (iqb 2024MerhoehtAAnalysis11-b, 2017MerhoehtBAnalysisWTR3-2e); „Gleichung einer senkrechten Strecke mit Parameterbereich im Sachzusammenhang angeben“ → „Gleichung einer Strecke mit Parameterbereich im Sachzusammenhang angeben“ (iqb 2017MgrundlegendBAGLAA2WTR2-1f, 2017MerhoehtBAGLAA2WTR3-1d); „Ebene Figur: Größeren Flächeninhalt des Schattens eines geneigten Rechtecks bei senkrechtem Lichteinfall begründen“ → „Ebene Figur: Flächeninhalt des Schattens eines geneigten Rechtecks bei senkrechtem Lichteinfall über eine Querschnittsskizze begründen“ (iqb 2017MgrundlegendBAGLAA2WTR2-1g, 2017MerhoehtBAGLAA2WTR2-1e); „Übergangsprozess: Verteilung nach einem Übergang berechnen und einen Anteil angeben“ → „Übergangsprozess: Verteilung nach einem Übergang berechnen“ (iqb 2018MgrundlegendBAGLAA1WTR-1d, 2022MgrundlegendBAGLAA1WTR-1b, 2017MerhoehtBAGLAA1WTR-1e); „Übergangsprozess: Zeitpunkt für das Unterschreiten eines Anteils der Populationsgröße über einen konstanten Faktor bestimmen“ → „Übergangsprozess: Zeitpunkt für das Unter- oder Überschreiten einer Schranke über einen konstanten Faktor bestimmen“ (iqb 2024MerhoehtBAGLAA1WTR-1d, 2021MgrundlegendBAGLAA1WTR-1f, 2017MerhoehtBAGLAA1WTR-1g, typ_neben 2026MgrundlegendBAGLAA1MMS-1d); „Scharparameter den Graphen über Lage zur x-Achse und Höhe der Hochpunkte zuordnen“ → „Scharparameter den Graphen über die Lage der Hochpunkte zuordnen“ (iqb 2017MerhoehtBAnalysisWTR3-1e, 2017MerhoehtBAnalysisCAS2-1a); „Maximalen Neigungswinkel über die Wendestelle berechnen und mit einer Schranke vergleichen“ → „Maximalen Neigungswinkel über die Wendestelle berechnen“ (abi 2017-be-gk 1.1 c; iqb 2024MerhoehtBAnalysisWTR3-1c, 2017MgrundlegendBAnalysisWTR-1h, 2017MerhoehtBAnalysisCAS1-2c); „Gleichung f(t) = f(t − c) für gleiche Werte im Abstand c mit dem Rechner lösen und im Graphen darstellen“ → „Gleichung f(t) = f(t − c) für gleiche Werte im Abstand c mit dem Rechner lösen“ (iqb 2026MerhoehtBAnalysisMMS2-1b, 2017MerhoehtBAnalysisCAS1-2e); „Berührpunkt einer Tangente durch einen vorgegebenen Graphenpunkt berechnen“ → „Berührpunkt einer Tangente durch einen vorgegebenen Punkt berechnen“ (iqb 2017MerhoehtBAnalysisCAS2-2d). **Getrennt gelassen** (anderer Weg oder Gegenstand): Extrempunkte einer Schar mit Art ohne gegen mit Fallunterscheidung nach dem Parametervorzeichen, Funktionswert an einer Stelle ablesen gegen Stelle zu einem Funktionswert, Zeitraum der Abnahme berechnen gegen Zunahme begründen, Matrixparameter aus einer Überlebensrate gegen aus einer Komponente nach zwei Schritten, σ gegen μ einer Normalverteilung aus einer Wahrscheinlichkeit, Ablehnungsgrenze bei größerem Umfang gegen Entscheidungsregel, stumpfer Winkel zweier Seitenflächen gegen Innenwinkel Dach–Wand, Punkt mit Abstand zu einem festen Punkt gegen zum Aufpunkt. Angefasst: 14 Zeilen im abi-Katalog (9 Verweise, 5 Typfelder: 2017-be-gk 1.1 c, d; 2025-bebb-lk 1.2 b; 2026-bb-gk 2.1 b; 2026-bb-ea 2.1 e) und 29 im iqb-Katalog; alle Paare im selben Thema, kein Präfix geändert, geteilte Typen der Dubletten (2025-bebb-lk 1.2 b ↔ 2025MerhoehtAAnalysis13-b) in beiden Katalogen gleich. Lauf aus einer frischen Repo-Kopie (HEAD cc451d5) byteidentisch (iqb-katalog.csv, abi-katalog.csv, abitur-typen.csv); Selbstprüfung beider Bau-Skripte bestanden (abi 855 Zeilen aus 19 Heften, 1393 Typen, 257 nur hier, 373 in beiden Katalogen, 1 offene Vormerkung; iqb 1639 Zeilen, 41 Stapel vollständig, vorgemerkt nur 2018-ea-B-cas 1). Alte Namen in sieben Sek-II-Einträgen (katalog/*.md) wortgleich ersetzt, in stammfunktion-und-hauptsatz.md Einheit 3 zwei Einträge zu einem (3) zusammengefasst und die Zählzeile auf 28 Haupttypen gesetzt; die erzeugten Dateien katalog/_pruefungswort-belege.md, katalog/_kursart-belege.md, rohdaten/, werkzeuge/pruefungswort-belege-typen.txt und werkzeuge/themen-inventar.md nennen noch alte Namen, themen.csv zählt den Stand vor dem Lauf (nachzuziehen in Teil 4 des Auftrags). |
| 2026-09-25 | Abgleichlauf 24 (abitur-abgleich.py v0.25; Auftrag Nacht 2026-09-27, Teil 10 Punkt 4) nach 2017-bb-ea-cas, 2018-bb-ea-cas, 2017-ga-A, 2017-ga-B (WTR) und 2017-be-gk: die 26 neuen Typen gegen alle Typen derselben Leitidee verglichen (Wortmenge von Name und Definition, Zeichenfolge des Namens), die Etikettenvorschläge der fünf Läufe an gegeben, gesucht und verfahren aller Zeilen der betroffenen Typen geprüft. Neun Umbenennungen und vier Zusammenziehungen, Typenliste 1349 → 1345; 34 Zeilen im abi-Katalog (typ 26, typ_neben 8: 2017-be-gk 1.2 b, d, 2.1 c, 2.2 c, e, 3.1 g, 3.2 e; 2017-bb-ea 3.1 e, 4.2 b; 2017-bb-ea-cas 3.1 e, 4.2 b; 2018-bb-ea 1.2 b; 2018-be-gk 1.1 f, 1.2 d, 2.1 d, 2.2 a; 2019-be-gk 2.1 f, 2.2 b, 3.1 a, 4.1 b; 2020-be-gk 1.4 a, 2.1 c, e, 2.2 d, 4.1 c; 2021-be-gk 4 e; 2022-bebb-gk 4 d; 2022-bebb-lk 4 m; 2023-bebb-gk 4.1 f; 2024-bebb-gk 2.1 b; 2025-bebb-gk 1.4 b, 2.2 b, g; 2025-bebb-lk 2.2 g) und 22 im iqb-Katalog umgestellt; alle Paare im selben Thema, kein Präfix geändert, Zeilenthema = Typthema erhalten, geteilte Typen der Dubletten (2017-be-gk 3.1 g ↔ 2017MgrundlegendBStochastikWTR1-2e, 2025-bebb-gk 1.4 b, 2.2 b, g) in beiden Katalogen gleich umgestellt. **Umbenennungen** (Etikett neutral zur Verwendung, Kern § 6; Definition jeweils erweitert): „Mindestanzahl von Versuchen einer Bernoulli-Kette über das Gegenereignis bestimmen“ → „Anzahl von Versuchen einer Bernoulli-Kette für mindestens einen Treffer über das Gegenereignis bestimmen“ (2017-bb-ea-cas 4.2 b fragt die größte Anzahl, gleicher Weg); „Hochpunkt eines Produkts aus Polynom und e-Funktion berechnen“ → „Extrempunkt eines Produkts aus Polynom und e-Funktion berechnen“ (Tiefpunkt in 2017-ga-B, Extrempunkt in 2025-ea-B und 2020-be-gk); „Funktionalgleichung mit Zeitverschiebung grafisch lösen und im Sachzusammenhang deuten“ → „Funktionalgleichung mit Verschiebung grafisch lösen und im Sachzusammenhang deuten“ (2017-ga-B: Verschiebung im Ort); „Streckenlänge im Raum berechnen“ → „Streckenlänge berechnen“ (2017-ga-B: Brücke in der Ebene; Thema Abstände bleibt); „Vierten Eckpunkt eines Quadrats über eine Vektoraddition bestimmen“ → „Vierten Eckpunkt eines Parallelogramms über eine Vektoraddition bestimmen“ (2017-ga-B: Rechteck; die Vektoraddition ist die Parallelogrammregel); „Höhenunterschied zweier übereinanderliegender Punkte auf Seilgeraden bestimmen“ → „Höhenunterschied senkrecht übereinanderliegender Punkte über gleiche x- und y-Koordinaten bestimmen“ (2017-be-gk 2.1 c: Jet über dem Rathaus); „Wahrscheinlichkeit für Gewinn und Extrapreis über die Aufteilung einer Bernoulli-Kette in zwei Abschnitte berechnen“ → „Wahrscheinlichkeit für zwei gleichzeitige Ereignisse über die Aufteilung einer Bernoulli-Kette in zwei Abschnitte berechnen“ (2017-be-gk 3.2 e, Rest dort kumuliert statt über das Gegenereignis); „Körper: Gesamtlänge der Dachkanten einer Pyramide mit Zuschlag berechnen“ → „Körper: Gesamtlänge gleich langer Strecken an einem Körper über einen Vektorbetrag berechnen“ (2017-be-gk 2.2 e: acht Drähte); „Graphen einer Funktion in ein vorgegebenes Koordinatensystem einzeichnen“ → „Graphen einer Funktion in ein Koordinatensystem einzeichnen“ (2017-be-gk 1.2 b ohne vorgegebenes Koordinatensystem; vorgeschlagen war nur die Definition, der Name hätte der Verwendung dann widersprochen). **Zusammenziehungen** (dieselbe Fertigkeit unter zwei Namen): „Fläche: Fläche zwischen Graph und Koordinatenachsen berechnen“ + „Fläche: Fläche zwischen Graph und x-Achse zwischen zwei Nullstellen berechnen“ → „Fläche: Fläche zwischen Graph und x-Achse aus einem Flächenstück berechnen“ (ein Integral ohne Vorzeichenwechsel, nur die Herkunft der Grenzen verschieden; Gegenstück zu „… aus zwei Flächenstücken …“); „Scharparameter aus einem vorgegebenen Flächeninhalt zwischen Graph und x-Achse berechnen“ + „Scharparameter für einen vorgegebenen Flächeninhalt zwischen Graph und x-Achse bestimmen“ → „Scharparameter für einen vorgegebenen Flächeninhalt zwischen Graph und x-Achse bestimmen“ (Integral als Term im Parameter gleich dem Inhalt; ob die Grenzen vom Parameter abhängen, ändert den Weg nicht); „Stichprobenumfang für eine verdoppelte Standardabweichung der Binomialverteilung ermitteln“ + „Versuchszahl aus Standardabweichung und Trefferwahrscheinlichkeit berechnen“ → „Stichprobenumfang aus einer vorgegebenen Standardabweichung der Binomialverteilung berechnen“ (dieselbe Gleichung σ = √(npq) nach n, die Vorgabe als Wert oder als Doppeltes); „Parameter einer Schar aus einem vorgegebenen Punkt auf dem Graphen bestimmen“ + „Scharparameter aus einem Punkt des Graphen angeben“ → „Scharparameter aus einem Punkt des Graphen angeben“ (Synonym aus 2021-ga-B, Befund der Ähnlichkeitssuche, nicht unter den Vorschlägen). **Getrennt gelassen:** Horizontalabstand aus Neigung gegen Neigung aus Horizontalabstand (Umkehraufgabe, anderer Gegenstand), Funktionalgleichung grafisch gegen f(t) = f(t − c) mit dem Rechner (anderer Lösungsweg), Schnittpunkte zweier Graphen mit dem Rechner gegen Zeitpunkt für einen Bestand mit dem Rechner (anderer Gegenstand), Quadratfläche über die Seitenlänge gegen Flächenverhältnis zweier Quadrate und Dreiecksfläche über die Katheten, die Mindestumfang-Typen mit kumulierten Werten (Probieren statt Gegenereignis). Vermerke in bemerkung, die das alte Etikett nennen (2017-be-gk 1.2 b, 2.1 c, 2.2 e, 3.2 e; 2017-bb-ea-cas 4.2 b), bleiben als Erfassungsbefund stehen. Lauf aus einer frischen HEAD-Kopie byteidentisch; Selbstprüfung beider Bau-Skripte bestanden (abi 855 Zeilen aus 19 Heften, 1345 Typen, 272 nur hier, 357 in beiden Katalogen; iqb 1502 Zeilen, 39 Stapel vollständig). Die vier Vormerkungen der CAS-Nachträge bleiben (Poolzeilen nicht erfasst). Der Themenkatalog (katalog/*.md, werkzeuge/pruefungswort-belege-typen.txt, werkzeuge/themen-inventar.md) nennt noch alte Namen; nicht angefasst. |
...
| 2026-09-17 | Auftrag C, Teil 1: Markdown-Korpus 2023-bebb-lk (hefte-md/, außerhalb des Repos): 66 von 66 Teilaufgaben, 0 Abweichungen bei BE/Struktur, 57 Ergebnisse nachgerechnet, 0 Abweichungen; 9 Abbildungen (§ 4). |
...
| 2026-09-17 | Auftrag C, Teil 5: Bestandsaufnahme des Repos als befund-repo-bestand.md (53 Dateien je Projekt zugeordnet, Auffälligkeiten; nichts verschoben, umbenannt oder gelöscht). |
...
| 2026-09-17 | Abgleichlauf 20 (Vorrang des Amtlichen, Entscheidung des Lehrers): niveau_geschaetzt in 11 abi-Zeilen auf den amtlichen Bereich der Poolzeile nachgezogen – 2022-bebb-gk 2.1 a, j, 3 b, e (II → I), 2.1 g, k (III → II), 3 i (II → III); 2017-bb-ea 1.2 b, 1.3 b, 2018-bb-ea 1.1 a, 1.2 b (II → III); dazu 9 iqb-Zeilen von 2022-ga-B. Kern v0.6 (§ 5 Vorrang des Amtlichen), abi.md v0.15 (§ 7), iqb.md v1.8, iqb-bau.py v1.5 (Überschreibung der Eichschwelle zurückgebaut), abitur-abgleich.py v0.20. Eichung 2022-bebb-gk 23 von 24. Typen unverändert (1124). |
