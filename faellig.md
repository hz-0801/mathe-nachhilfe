...
Stand 21.09.2026 (zweiter Eintrag in § 4; Posten Blatt-0-Dateiverweise der sieben weiteren Sek-I-Einträge in § 2) · angelegt in Auftrag O, Punkt 5 · gilt für alle Profile
...
| katalog: gebündelte Geltungsrecherche zu den reinen Poolthemen – Prüfungsrelevanz von Matrizen und Übergangsprozessen (Alternative A1 des Pools) und Konfidenzintervallen für künftige Jahrgänge (ab Abitur 2030) klären: künftige Prüfungsschwerpunkte beider Länder und die KMK/IQB-Dokumente auf beide Themen prüfen, Ergebnis in die vier Geltungsdateien und die Vermerke in katalog/matrizen-und-uebergangsprozesse.md und katalog/konfidenzintervalle.md nachtragen | Sek-II-Serie abgeschlossen (2026-09-20, Auslöser eingetreten); spätester Anlass ist der Vorgabencheck abi/iqb 2028 (§ 1) bzw. der Hilfsmittel-Check 2030 (dieser Abschnitt) | Claude | Auftrag Serienbau Bündel 9–11 (2026-09-20); katalog/matrizen-und-uebergangsprozesse.md und katalog/konfidenzintervalle.md „Offene Punkte“ |
...
| katalog: Blatt-0-Dateiverweise in den sieben Sek-I-Einträgen nachtragen, die der Auftrag vom 21.09.2026 nicht erfasste, weil ihr Abschnitt schon irgendeinen Verweis trug – potenzen-wurzeln, reelle-zahlen, trigonometrische-funktionen, zinsrechnung (Stufe Sek I), daten, einheiten, lineare-gleichungssysteme (Sek I + II): 54 Fertigkeitszeilen ohne Ziel, die meisten mit Nennung in Wortform („Thema Prozentrechnung, Einheit 3“), einige mit „Kein eigenes Thema“; die themen.csv-Treffer stehen je Zeile in katalog/_blatt0-belege.md Teil 2; Vorgehen wie am 21.09.2026 (Ersetzungsdatei des Lehrers, Skriptlauf, `tragfaehigkeit.py` und `verweis-pruef.py` neu) | Ersetzungsdatei des Lehrers (Zuordnung Titel → Datei ist seine Entscheidung); kein Termin | Lehrer (Ersetzungen), Claude (Lauf) | katalog/_blatt0-belege.md Teil 2 und Kennzahl 9 in `_pruef_struktur.py` (93 von 463 Zeilen ohne Ziel); archiv/auftrag-blatt0-verweise-2026-09-21.md (Muster) |
