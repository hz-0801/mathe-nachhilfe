...
Stand 19.09.2026 · angelegt in Auftrag O, Punkt 5 · gilt für alle Profile
...
| katalog: Nacharbeiten zu Entscheidung 37 – (a) kombinatorik.md bauen (32 Zeilen, rohdaten/kombinatorik.md), danach die Voraussetzungszeile Kombinatorik in zufallsexperimente-und-pfadregeln.md und binomialverteilung.md schließen; (b) die Blatt-0-Verweise der Trägerabnehmer vierfeldertafel.md, bedingte-wahrscheinlichkeit-und-bayes.md, hypergeometrische-verteilung.md und (teilweise) unabhaengigkeit.md von wahrscheinlichkeit.md auf zufallsexperimente-und-pfadregeln.md umstellen und in sechs Verortungen den Satz „→ wahrscheinlichkeit.md (Sek I, kanonisch)“ für die abi/iqb-Baumthemen berichtigen; (c) daten.md, lineare-gleichungssysteme.md und einheiten.md um den Sek-II-Teil erweitern; (d) werkzeuge/themen-pruef.py Prüfung 4 an die Namensregel der Entscheidung 37 anpassen – ein kanonischer Sek-II-Name mit eigener Katalogdatei, der weder Vokabular- noch abi/iqb-Thema ist, gilt seit Commit 3d33427 als Abweichung – und die Bemerkung „Katalogdatei folgt (E37)“ der neun Zeilen in themen.csv löschen | Entscheidung 37 (2026-09-20); der Eintrag zufallsexperimente-und-pfadregeln.md liegt seit dem 20.09.2026 vor; (d) sofort, weil themen-pruef.py sonst nach jeder Katalogänderung eine Abweichung meldet | Claude | konzept.md § 4 Entscheidung 37; katalog/zufallsexperimente-und-pfadregeln.md „Offene Punkte“ (Befund Trägerthema, Prüfskripte) |
