...
Stand 20.09.2026 (erster Eintrag in § 4) · angelegt in Auftrag O, Punkt 5 · gilt für alle Profile
...
| katalog: Blatt-0-Verweise der neun Stochastik-Trägerabnehmer nachziehen (Rest der Nacharbeiten zu Entscheidung 37) – vierfeldertafel.md, bedingte-wahrscheinlichkeit-und-bayes.md, hypergeometrische-verteilung.md und (teilweise) unabhaengigkeit.md von wahrscheinlichkeit.md auf zufallsexperimente-und-pfadregeln.md umstellen, in sechs Verortungen den Satz „→ wahrscheinlichkeit.md (Sek I, kanonisch)“ für die abi/iqb-Baumthemen berichtigen; dazu in hypergeometrische-verteilung.md die Blatt-0-Zeile „Thema kombinatorik.md“ mit Einheitsnummer versehen (Einheit 2) und in wahrscheinlichkeit.md die Verortungs-Angabe „Fakultät und Binomialkoeffizient (H): nicht hier, Vorrat → gost-stochastik.md, fos-stochastik.md“ auf kombinatorik.md umstellen | Entscheidung 37 (2026-09-20); eigener Auftrag, die Verweise sind vom Auftrag „E37 abschließen“ ausdrücklich ausgenommen | Claude | konzept.md § 4 Entscheidung 37; katalog/zufallsexperimente-und-pfadregeln.md „Offene Punkte“ (Befund Trägerthema); katalog/kombinatorik.md „Offene Punkte“ (Befund Sek-I-Anschluss, Befund Abnehmer) |
