...
Zentrale schriftliche Prüfung zum Erwerb der Fachhochschulreife im Land Brandenburg, Fach Mathematik. Sie gilt für die Bildungsgänge der Fachoberschule, den doppelqualifizierenden Bildungsgang und das Zusatzangebot im Rahmen einer Berufsausbildung; Rechtsgrundlage ist die Fachoberschul- und Fachhochschulreifeverordnung (FOSFHRV), die Aufgaben werden nach § 31 Absatz 1 zentral festgelegt. Sagt der Lehrer FOS, FHR oder Fachhochschulreife, ist dieses Profil gemeint. Nur ein Niveau, keine Wahlaufgaben, keine Anforderungsbereiche im Heft. Bestand: die sechzehn Hefte 2019–2026 laut fhr-pruefungen.md, seit dem 12.09.2026 alle erfasst.
...
Ein Heft enthält drei voneinander unabhängige, mehrteilige Aufgaben mit Überschrift – zweimal Differential- und Integralrechnung, einmal Stochastik –, laut Prüfungsschwerpunkten sind auch vier möglich, im Bestand kommen nur drei vor. Punkte: meist 30 + 20 + 20 = 70, mit Abweichungen (2026 C 27 + 23 + 20, 2021 B 32 + 18 + 20, 2020 A 28 + 21 + 21, 2020 C 29 + 21 + 20); die Gesamtsumme ist immer 70. Arbeitszeit 180 Minuten. Jede Aufgabe gliedert sich in Teilaufgaben a) bis h) mit Aufgabenstamm; am Ende jeder Aufgabe steht eine Punktetabelle „Aufgabenteil / Punkte" mit Summe. Praxisbezug ist möglich, in der Analysis meist nicht vorhanden, in der Stochastik in der Regel gegeben.

Drei Seitensorten: Aufgabenseite (Aufgabentext, Punktetabelle), Erwartungshorizont („Teil / Erwartete Teilleistung / Pkt.") und als letzte Seite der Gutachtenbogen. Sechs Hefte haben keinen Gutachtenbogen: 2023 C (die Datei endet nach dem Erwartungshorizont mit „Seite 8 von 9"), 2021 B sowie alle vier Hefte der Jahrgänge 2019 und 2020; die Punkteaufteilung kommt dann aus dem Erwartungshorizont, der ohnehin feiner aufteilt. Der Gutachtenbogen listet jede Teilleistung in Worten mit ihrem BE-Soll und ist die bequemste Quelle für die Punkteaufteilung; er fasst gelegentlich gröber zusammen als der Erwartungshorizont (2026 C, 3a: Gutachten 2 + 2, Erwartungshorizont 1 + 1 + 2).
...
Hilfsmittel ab 2021 durchgehend im Heft genannt, in den Heften 2019 und 2020 gar nicht (dort steht `hilfsmittel` aus den Vorgaben auf „ja"): Formelsammlung, Nachschlagewerk Rechtschreibung, Taschenrechner ohne Programmierbarkeit, Grafik, numerisches Differenzieren oder Integrieren und ohne automatisches Gleichungslösen. Nichtganzzahlige Ergebnisse werden auf zwei Dezimalstellen gerundet.
...
Stochastik: Daten darstellen und aufbereiten · Statistische Kenngrößen · Mehrstufige Zufallsexperimente · Baumdiagramm und Pfadregeln · Laplace-Wahrscheinlichkeit · Unabhängigkeit von Ereignissen · Erwartungswert · Kombinatorische Abzählverfahren (27)
...
- Elementargeometrie als Werkzeug: Dreiecks-, Rechteck- und Körperflächen kommen in Analysis-Aufgaben vor, die Themenliste hat dafür keinen Eintrag. Solche Teilaufgaben werden beim nächstliegenden Thema geführt (2026-B-1h bei Anstieg und Tangente, weil das Dreieck von der Tangente eingeschlossen wird; 2025-A-2d und 2023-A-1e bei Extremwertaufgaben, weil die Rechteck- beziehungsweise Dreiecksfläche der erste Schritt einer Extremwertaufgabe ist) und im Bericht gemeldet. Reine Umrechnungen über einen Maßstab gehen nach Grundlagen / Größen und Einheiten.
...
- thema bei einleistigen Zeilen: Hier gilt das Thema des typ, außer der typ wird ersichtlich für eine andere Fertigkeit gebraucht als bei seiner Anlage. 2023-A-3a füllt eine Vierfeldertafel aus Randangaben, ohne nach Unabhängigkeit zu fragen, und läuft deshalb unter Daten darstellen und aufbereiten, während der typ Vierfeldertafel vervollständigen unter Unabhängigkeit von Ereignissen steht. Der Fall gehört in den Bericht und beim Abgleichlauf auf die Liste.
...
- Die Überlappung Mehrstufige Zufallsexperimente / Baumdiagramm und Pfadregeln ist mit der Arbeitsregel in § 6 geklärt. Erwartungswert ist seit 2021-B-3e belegt; jedes Thema der Liste hat damit eine Ankeraufgabe, drei Themen stellen aber in keiner Zeile das thema (Stammfunktion bilden, Bestimmtes Integral berechnen, Gleichungen lösen).
- Zweiter Abgleichlauf am 12.09.2026, nach der Erweiterung auf 2021–2026: 128 Typen auf 125 zusammengeführt, alle auf Status „geprüft". Die Stufenzahl trägt keinen Typnamen mehr, wo sie nicht trennt – unter Mehrstufige Zufallsexperimente heißen die Typen jetzt mehrstufig mit beziehungsweise ohne Zurücklegen, je zwei Paare wurden zusammengezogen. Unter Baumdiagramm und Pfadregeln bleibt „zweistufig" im Namen stehen, weil es dort nach der Arbeitsregel in § 6 die Themenbedingung ist und nicht bloß eine Stufenzahl; die Uneinheitlichkeit ist der Preis dafür, dass Typen nicht über Themengrenzen zusammengezogen werden. Wendepunkt aus vorgegebenen Punkten auswählen ist entfallen und geht in Wendepunkte über zweite Ableitung auf – der Lösungsweg ist derselbe, die Auswahl aus Kandidaten ist Format und ändert den Typ nicht. Wahrscheinlichkeitsverteilung der Augensumme aufstellen heißt jetzt Wahrscheinlichkeitsverteilung aufstellen, weil der Beleg 2022-B-3e Glücksräder betrifft.
- Beim Abgleichlauf am 12.09.2026 bewusst nicht geändert: Schnittpunkt mit der y-Achse bleibt unter Nullstellen ganzrationaler Funktionen, obwohl der y-Achsenschnitt keine Nullstelle ist – ein eigenes Thema für einen Typ lohnt nicht. Ein Thema für Elementargeometrie („Flächen und Körper" unter Grundlagen) wurde verworfen, weil solche Teilleistungen nie eine eigene Aufgabe bilden; es bleibt bei der Regel in § 7. Der typ Vierfeldertafel vervollständigen bleibt unter Unabhängigkeit von Ereignissen (zwei der drei Vorkommen stehen dort), die Zeile 2023-A-3a behält davon abweichend thema Daten darstellen und aufbereiten. Dreiecksfläche aus Punktkoordinaten berechnen und Dreiecksfläche aus Achsenabschnitten einer Geraden bleiben getrennt, weil sie unter verschiedenen Themen stehen; Typen werden nicht über Themengrenzen hinweg zusammengezogen. Aus demselben Grund bleiben Extrempunkt und Wendepunkt über notwendige Bedingung ausschließen getrennt.
- Die Hefte 2019 und 2020 schreiben Koordinaten als P(–1|–5) und benutzen den ASCII-Bindestrich als Minus. Beim Erfassen gilt die Katalogschreibweise P(x; y) mit dem Minuszeichen „−", nicht die Schreibweise des Hefts.
- Erfassung der Hefte 2020 A und 2020 C am 12.09.2026: sechs neue Typen. Vier davon füllen Lücken, die der Bestand ab 2021 nicht zeigte – Aussagen zu Stellen mit waagerechter Tangente beurteilen und Punkte mit waagerechtem Anstieg berechnen (2020-C-1c fragt nach den Punkten mit Anstieg null, ohne ihre Art zu bestimmen; deshalb ein eigener Typ neben Extrem- und Sattelpunkte über zweite Ableitung), Streuung zweier Verteilungen vergleichen (2020-C-3c) und Variation ohne Wiederholung berechnen (2020-A-3e, Bedingung III). 2020-A-3b fragt nach der Gesamteinnahme einer Woche und nicht nach einem gewichteten Mittelwert; die Zeile läuft deshalb unter Grundlagen / Größen und Einheiten und nicht unter Erwartungswert, der damit weiterhin nur 2021-B-3e als Fundstelle hat.
- Zwei Vorschläge für den nächsten Abgleichlauf, hier nicht ausgeführt: die Definition von Produkt zweier Funktionsterme ausmultiplizieren auf mehrere Faktoren erweitern (2020-A-1a hat drei Linearfaktoren), und Dreieck in das Koordinatensystem einzeichnen mit dem neuen Rechteck in das Koordinatensystem einzeichnen zu einem Typ Figur in das Koordinatensystem einzeichnen zusammenziehen.
- Materiallage nach Abschluss des Bestands (253 Zeilen, 135 Typen): 487 Vorkommen über typ und typ_neben, also 3,61 je Typ. 49 Typen kommen genau einmal vor, 27 zweimal, 13 dreimal, 46 viermal oder öfter. Für den Blattbau heißt das weiterhin, dass Ketten überwiegend aus selbstgebauten Sprossen bestehen.
- Entscheidungsgrundlage für die Decke-Regel: 29 der 135 Typen haben kein einziges Vorkommen ab 2023, darunter beide Fundstellen des Themas Erwartungswert (2019-C-3d und 2021-B-3e). Bleibt die Regel „Decke immer ab 2023", lässt sich für diese 29 Typen keine vollständige Kette bauen. Der Zuwachs neuer Typen je Jahrgang rückwärts beträgt 25, 18, 11, 9, 7, 11, 3 und 2 – die beiden ältesten Jahrgänge haben kaum noch Neues gebracht.
