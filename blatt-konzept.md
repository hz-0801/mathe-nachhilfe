...
- Typenliste je Thema aus `msa-typen.csv` – ersetzt das Erraten der Typen (Masterprompt 2.1). Jede Hauptnummer ist ein Katalog-Typ, die Kette läuft innerhalb des Typs von leicht bis Decke. Das überschreibt Masterprompt 2.1 („Formel und Umkehrung = ein Typ"): Der Katalog führt Prozentwert, Grundwert und Prozentsatz als drei Typen mit je eigener Decke.
