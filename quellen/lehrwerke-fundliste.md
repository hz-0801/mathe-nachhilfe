# Fundliste – Stoffverteilungspläne Landesausgaben BE/BB

Stand 24.09.2026 (Auftrag Nacht, Teil 2). Gesucht: frei zugängliche
Stoffverteilungspläne, Fahrpläne oder Synopsen zum Rahmenlehrplan 1–10
Berlin-Brandenburg, Mathematik Klasse 7–10 (bzw. 5–10, soweit angeboten), für
die in `auftrag-nacht-2026-09-24.md` § Teil 2 genannten Lehrwerke. Je Werk
höchstens zehn Minuten gesucht, ohne Login, Formular oder Registrierung.
Nichts bewertet, nichts erfasst – nur der Fund.

| Verlag | Werk | Landesausgabe BE/BB | Schulform laut Verlag | Klassen | Fund |
|---|---|---|---|---|---|
| Klett | Lambacher Schweizer | ja (Allgemeine Ausgabe, Fahrplan deckt BB-Niveaustufen und Berlin GOST ab) | Gymnasium | 5–10 + Oberstufe | bereits vorhanden: `quellen/quelle-klett-fahrplan-ls-aa-berlin-2024.txt` [LS-AA] |
| Klett | Schnittpunkt Mathematik | ja (Differenzierende Ausgabe BE, BB, HB, HH, HE, MV, NI, SH, ST, TH ab 2017) | Integrierte Sekundarschule (Berlin) | 5–10 | nicht gefunden (Suchbegriffe: Stoffverteilungsplan, Synopse; der Bundesland/Schulart/Fach-Filter auf klett.de liefert für Berlin/ISS/Mathematik nur „Kompetenzraster" Klasse 5–10, keinen Stoffverteilungsplan; eine direkte Produktseite mit Downloadlink wie bei Westermann wurde nicht gefunden) |
| Klett | Mathe live | nicht gefunden (nur Allgemeine Ausgabe und Ausgabe N/Niedersachsen) | – | – | nicht gefunden (Suchbegriffe: Mathe live Berlin Brandenburg Ausgabe) |
| Westermann | Elemente der Mathematik SI | ja (Ausgabe 2016 für Berlin/Brandenburg, dazu eine Ausgabe 2025) | – (Sekundarstufe I allgemein) | 5–9 | gefunden und gesichert: `quellen/quelle-westermann-elemente-der-mathematik-bb-2016.txt` [EDM-BB], Stoffverteilungspläne Kl. 5–9 (kein Kl. 10 angeboten) |
| Westermann | Mathematik Neue Wege | nur SII/Oberstufe (Ausgabe 2011 für Berlin, Rheinland-Pfalz, Saarland und Schleswig-Holstein) | Sekundarstufe II | – | nicht gefunden für Sek I (Suchbegriffe: Mathematik Neue Wege Berlin Brandenburg Synopse); die gefundene BE-Ausgabe ist Oberstufe, außerhalb des Auftrags |
| Westermann | Sekundo | ja (Ausgabe 2017 für Berlin und Brandenburg) | differenzierende Schulformen | 7–10 | gefunden und gesichert: `quellen/quelle-westermann-sekundo-bb-2017.txt` [SEKUNDO-BB], Stoffverteilungspläne Kl. 7–10 |
| Westermann | maßstab | umbenannt/fortgeführt als „Mathematik – Ausgabe 2023 für Berlin, Brandenburg, Sachsen-Anhalt, Thüringen, 7.–10. Schuljahr" (Nachfolge der Reihe maßstab) | Oberschule | 7–10 | Landesausgabe gefunden, aber kein Stoffverteilungsplan auf der Produktseite verlinkt (Suchbegriffe: Stoffverteilungsplan, Synopse); nicht gesichert |
| Cornelsen | Fundamente der Mathematik | ja (Ausgabe B ab 2017, auf Basis Rahmenlehrplan 2017/18 für Berlin und Brandenburg) | Gymnasium Klassen 5/7–10 | 8, 9, 10 (als „Synopse" einzeln gelistet) | gefunden, aber nicht frei verfügbar: Synopsen kosten 0,00 EUR, sind aber nur über „In den Warenkorb" und laut Produktseite nur an Lehrpersonen/Schulen bestellbar (Registrierung nötig) – nicht heruntergeladen |
| Cornelsen | Fokus Mathematik | nein | – | – | nicht gefunden (Suchbegriffe: Fokus Mathematik Berlin Brandenburg Ausgabe Synopse; keine Landesausgabe BE/BB in den Treffern) |
