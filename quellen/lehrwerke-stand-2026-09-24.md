# Stand – Auftrag Lehrwerke Sek II und Förderhefte

Standdatei des Auftrags auftrag-lehrwerke-sek2-foerder.md
(2026-09-24). Wird nach jedem Teil fortgeschrieben; ein Neustart
macht beim ersten offenen Punkt weiter. Nach dem Auftrag bleibt
sie als Beleg liegen.

| Punkt | Stand | Bände | Bemerkung |
|---|---|---|---|
| Schritt 0 Gegenprobe | erledigt | – | Satz 1338042475, TOC:ja bestätigt (python312, dnb-sru.py); pdftotext über MiKTeX bereits im PATH |
