...
Stand 2026-09-26, Katalog auf Commit ca3237b.
...
- **index.md** (liegt in blaetter/, katalog/) – 50 Verweise aus 48 Einträgen
  - ableitung-und-aenderungsrate.md (Offene Punkte)
  - ableitungsgraph-und-funktionsgraph.md (Offene Punkte)
  - ableitungsregeln.md (Offene Punkte)
  - abstaende.md (Offene Punkte)
...
3966 Einheitenangaben in den Einträgen. Direkt hinter einem Verweis: 532 (532 geprüft, 0 nicht prüfbar, weil das Ziel kein Katalogeintrag ist); davon Nummer größer als vorhanden: 1. Nicht eindeutig einem Verweis zuordenbar: 25. Die übrigen 3409 stehen ohne Verweis davor oder weiter von ihm entfernt; sie gelten als eigene Einheiten des Eintrags und sind nicht geprüft.
...
- trigonometrie.md: H1 „Trigonometrie“ – gleich: –; abweichend: msa „Trigonometrie im rechtwinkligen Dreieck“, msa „Sinus- und Kosinussatz“
...
(d) msa/fhr-Themen gegen den Typenkatalog: msa: 32 thema-Werte in `themen.csv`, 36 Themen in `msa/msa-typen.csv`, 4 Abweichungen; fhr: 28 thema-Werte in `themen.csv`, 29 Themen in `fhr/fhr-typen.csv`, 1 Abweichungen.
- msa/msa-typen.csv nennt ein Thema ohne msa-Zeile in themen.csv: „Kongruenz und Konstruktion“
- msa/msa-typen.csv nennt ein Thema ohne msa-Zeile in themen.csv: „Runden und Überschlag“
- msa/msa-typen.csv nennt ein Thema ohne msa-Zeile in themen.csv: „Trigonometrische Funktionen“
- msa/msa-typen.csv nennt ein Thema ohne msa-Zeile in themen.csv: „Ähnlichkeit und Strahlensätze“
