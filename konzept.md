...
Hier steht, warum es einen Baustein gibt. Wann man welche Datei öffnet, sagt README.md; Umbenennungen und Daten stehen in § 10 und in namensschema.md.
    ...
    hefte/, hefte-md/, korpus/, baende/   lokal, nicht im Repo: Verlagsmaterial, Korpus, Sammelbände und der Cache der Pool-PDFs (hefte/iqb/, Standard von iqb-quellen.py seit 27.09.2026, vorher iqb-pdf/) (.gitignore); pdf/ als Archiv der Hefte ist nicht angelegt (§ 6)
...
36. Sek-II-Eintragsform (2026-09-19): Sek-II-Einträge übernehmen den Sek-I-Aufbau aus katalog/_quellen.md mit drei Anpassungen. (1) Prüfungsform: statt P10-Typen die Typen aus den Rohdateien, je Profil getrennt (fhr, abi, iqb), mit der Geltung aus Entscheidung 35; der Eintrag setzt weiterhin keine Decke. (2) Das Feld „Für schwache Schüler" bleibt: Mindeststoff aus dem GK-Kernbereich je Kurshalbjahr (Q-Phase), der Niveaustufe H (E-Phase) bzw. dem RLP FOS (fhr); die Grundvorstellungs-Prüfung für Blatt 0 aus den Eingangsvoraussetzungen je Leitidee des RLP GOST Teil C Kap. 3.1; die Sprossen je Verfahrenstyp aus Lehrwerksgliederung und Rohdatei. (3) Quellenfolge: RLP GOST BB/BE 2022 samt Anlage ohne Hilfsmittel, RLP FOS 2019, Lehrwerksgliederung LS-AA (Einführungs- und Qualifikationsphase), abitur-vokabular.md für die Namen, die Rohdatei als Prüfungsbeleg; IQB-Begleitdokumente nur, wo abi/iqb betroffen ist. Drei neue Förderquellen: MaCo (DZLM, Förderbausteine, auch für die Sek-I-Pflege), BASICS (Springer 2020, Diagnose- und Förderstruktur am Übergang in die Oberstufe; nur Struktur, inhaltlich immer gegen die Eingangsvoraussetzungen des RLP GOST prüfen), COSH (Mindestanforderungskatalog Schule-Hochschule als Mindeststoff-Referenz für fhr, nachrangig für abi; Version 3.1 als `quellen/quelle-cosh-mindestanforderungskatalog-v3.1.txt`, seit 27.09.2026). Rangfolge der Absicherung: amtlich vor breit erprobt (MSK, MaCo) vor einzelerprobt (BASICS) vor Ermessen; jede Ermessensstelle wird als solche gekennzeichnet. MSK bleibt Primärquelle, wo es Bausteine hat; MaCo füllt geprüft dessen Lücken; wo beides fehlt, bleibt die Kennzeichnung „eigene Formulierung nach RLP und P10/Rohdatei". Straffung (2026-09-19): Die Prüfungsform enthält keinen eigenen Zuordnungs-Absatz; die Profillisten tragen je Typ die Einheitsnummer mit in der Klammer hinter der Zeilenzahl, Form „(17, E2)"„ (bei Typen unter einem „je 1:"-Präfix nur „(Ek)", weil die Zeilenzahl im Präfix steht)" – die Zuordnung steht damit genau zweimal im Eintrag: unter „Typen je Lerneinheit" und in den Profillisten. Grund: Der Pilot nannte jeden Typnamen dreimal. Kastenform (2026-09-19): Die Merkkästen bleiben Arbeitskästen je Lerneinheit (Regelzeilen mit Minimalbeispielen). Jeder Kasten trägt zusätzlich eine Markierungszeile „Auswendig (Teil A):", die benennt, welche Kastenteile laut Anlage ohne Hilfsmittel bzw. Profilvorgabe ohne Rechner und Formelsammlung sitzen müssen; „keine" ist zulässig. Ein themenweiter Stundenanker ist kein Katalogobjekt, sondern Kompositionsregel des Unterrichtsblatt-Prompts (Posten in faellig.md). Klarstellung Geometrie (2026-09-19): Wo die Eingangsvoraussetzungen der Leitidee den Stoff nicht tragen (Analytische Geometrie: L3 ist reine Sek-I-Geometrie), ist die Grundvorstellungs-Prüfung Ermessen und als solches gekennzeichnet; Blatt-0-Fertigkeiten dürfen auf Sek-II-Nachbarthemen derselben Stufe verweisen. Eintragsart Verweiseintrag (2026-09-19, entschieden vom Lehrer): Ein Thema, dessen Kompetenz vollständig in der Lerneinheit eines anderen Eintrags liegt, bekommt einen Verweiseintrag – eigener Kopf mit Eintragsart-Angabe, eigene Verortung und eigene Prüfungsform (fhr / abi / iqb) seiner Katalogzeilen; Lerneinheiten, Kästen, Voraussetzungen (Blatt 0), Fehlerquellen und Sprossen bestehen je aus einer Verweiszeile auf den tragenden Eintrag. Erster Fall: ableitungsgraph-und-funktionsgraph → kurvenuntersuchung.md Einheit 4 (kompetenzgleich). Kippbedingung: Bekommt das Thema eigene Typen, die die tragende Einheit nicht deckt, wird es Volleintrag.
...
37. Sek-II-Zeilen an Sek-I-Themen (2026-09-20, entschieden vom Lehrer): Vier Sek-I-Einträge und ein Thema ohne Datei tragen zusammen rund 300 Katalogzeilen aus fhr, abi und iqb, die in keinem Eintrag stehen (Kennzahl 5 nach der Sek-II-Serie: 345 von 2883). Maßgeblich ist nicht die Zeilenzahl, sondern die Kompetenz: Verlangen die Sek-II-Zeilen dasselbe Verfahren auf höherem Niveau, wird der vorhandene Eintrag um einen Prüfungsform-Teil nach Entscheidung 36 und um die nötigen Lerneinheiten erweitert; verlangen sie eigene Kompetenzen, bekommt die Oberstufe einen eigenen Eintrag unter eigenem kanonischem Thema. Die Zeilenzahl ist Indiz, keine Schwelle: unterhalb von etwa fünfzig Sek-II-Zeilen lohnt ein eigener Eintrag auch dann selten, wenn die Kompetenzen abweichen. Erster und größter Fall ist wahrscheinlichkeit: Die 237 Sek-II-Zeilen prüfen Termdeutung (zu einem gegebenen Produkt oder einer Potenz von Binomialkoeffizienten das Ereignis beschreiben, 21 Zeilen – der größte Typ des Themas), das Ergänzen fehlender Werte in einem Term, das Erschließen von Ast-Anteilen aus Randwahrscheinlichkeiten, den Nachweis der totalen Wahrscheinlichkeit und Mengenoperationen; der Sek-I-Eintrag endet didaktisch beim zweistufigen Ziehen ohne Zurücklegen. Sie ziehen deshalb in einen eigenen Eintrag zufallsexperimente-und-pfadregeln.md um; wahrscheinlichkeit.md bleibt unverändert der Sek-I-Eintrag und behält seine 37 P10-Originale. Der Name folgt dem sachlichen Schnitt der übrigen Stochastik-Einträge; ein Stufensuffix („-sek2") wird ausdrücklich nicht eingeführt. Zweiter Fall kombinatorik: bisher ohne Datei, 38 Zeilen, davon sechs aus dem MSA, die wahrscheinlichkeit.md Einheit 1 längst führt – die sechs gehen in der Konkordanz dorthin, die verbleibenden 32 werden ein reiner Sek-II-Eintrag kombinatorik.md. Er liegt in den Voraussetzungen von zufallsexperimente-und-pfadregeln.md (Termdeutung) und binomialverteilung.md; beide Einträge nennen ihn nach dem Bau unter „Voraussetzungen (Blatt 0)". Erweitert statt getrennt werden daten.md (30 Zeilen fhr/iqb), lineare-gleichungssysteme.md (14 Zeilen iqb) und einheiten.md (9 Zeilen fhr): dort sind es dieselben Verfahren. Ein erweiterter Sek-I-Eintrag führt beide Stufen in einer Datei und trägt für den Sek-II-Teil dieselben Felder wie ein Sek-II-Eintrag (Prüfungsform je Profil, Auswendig-Zeile im Kasten).
    Zahl: 345 von 2883 Originalen in keinem Eintrag, davon 237 wahrscheinlichkeit, 32 kombinatorik, 53 in daten, lineare-gleichungssysteme und einheiten (_pruef_struktur.py, Kennzahl 5, 2026-09-20).
    Kippt bei: Der Bau von zufallsexperimente-und-pfadregeln.md zeigt, dass die Oberstufenzeilen ohne die Sek-I-Einheiten nicht darstellbar sind (dann Erweiterung statt Trennung), oder der Blattbau braucht doch beide Stufen in einer Datei.
